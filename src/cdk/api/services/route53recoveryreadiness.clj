...
(defn cfn-cell-builder
  "Creates a  `CfnCell$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-cell-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cell-props-builder
  "Creates a  `CfnCellProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cell-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-readiness-check-builder
  "Creates a  `CfnReadinessCheck$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-readiness-check-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-readiness-check-props-builder
  "Creates a  `CfnReadinessCheckProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-readiness-check-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-recovery-group-builder
  "Creates a  `CfnRecoveryGroup$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-recovery-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-recovery-group-props-builder
  "Creates a  `CfnRecoveryGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-recovery-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-set-dns-target-resource-property-builder
  "Creates a  `CfnResourceSet$DNSTargetResourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-set-dns-target-resource-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-set-nlb-resource-property-builder
  "Creates a  `CfnResourceSet$NLBResourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-set-nlb-resource-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-set-r53-resource-record-property-builder
  "Creates a  `CfnResourceSet$R53ResourceRecordProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-set-r53-resource-record-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-set-resource-property-builder
  "Creates a  `CfnResourceSet$ResourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-set-resource-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-set-target-resource-property-builder
  "Creates a  `CfnResourceSet$TargetResourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-set-target-resource-property-builder>]] function, then builds it.  Takes the following arguments: 
