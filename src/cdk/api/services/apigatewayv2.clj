...
(defn add-routes-options-builder
  "Creates a  `AddRoutesOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[add-routes-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn api-mapping-attributes-builder
  "Creates a  `ApiMappingAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[api-mapping-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn api-mapping-builder
  "Creates a  `ApiMapping$Builder` instance using a scope and ID, applies the data configuration using the [[api-mapping-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
...
(defn api-mapping-props-builder
  "Creates a  `ApiMappingProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[api-mapping-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn batch-http-route-options-builder
  "Creates a  `BatchHttpRouteOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[batch-http-route-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-body-s3-location-property-builder
  "Creates a  `CfnApi$BodyS3LocationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-body-s3-location-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-cors-property-builder
  "Creates a  `CfnApi$CorsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-cors-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-gateway-managed-overrides-access-log-settings-property-builder
  "Creates a  `CfnApiGatewayManagedOverrides$AccessLogSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-gateway-managed-overrides-access-log-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-gateway-managed-overrides-builder
  "Creates a  `CfnApiGatewayManagedOverrides$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-api-gateway-managed-overrides-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-api-gateway-managed-overrides-integration-overrides-property-builder
  "Creates a  `CfnApiGatewayManagedOverrides$IntegrationOverridesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-gateway-managed-overrides-integration-overrides-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-gateway-managed-overrides-props-builder
  "Creates a  `CfnApiGatewayManagedOverridesProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-gateway-managed-overrides-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-gateway-managed-overrides-route-overrides-property-builder
  "Creates a  `CfnApiGatewayManagedOverrides$RouteOverridesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-gateway-managed-overrides-route-overrides-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-gateway-managed-overrides-route-settings-property-builder
  "Creates a  `CfnApiGatewayManagedOverrides$RouteSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-gateway-managed-overrides-route-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-gateway-managed-overrides-stage-overrides-property-builder
  "Creates a  `CfnApiGatewayManagedOverrides$StageOverridesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-gateway-managed-overrides-stage-overrides-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-api-mapping-builder
  "Creates a  `CfnApiMapping$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-api-mapping-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-api-mapping-props-builder
  "Creates a  `CfnApiMappingProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-api-mapping-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-authorizer-jwt-configuration-property-builder
  "Creates a  `CfnAuthorizer$JWTConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-authorizer-jwt-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `mutualTlsAuthentication` | software.amazon.awscdk.services.apigatewayv2.CfnDomainName$MutualTlsAuthenticationProperty | [[cdk.support/lookup-entry]] | `:mutual-tls-authentication` |
| `tags` | java.util.Map | [[cdk.support/lookup-entry]] | `:tags` |
"
...
(defn cfn-domain-name-domain-name-configuration-property-builder
  "Creates a  `CfnDomainName$DomainNameConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-domain-name-domain-name-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-integration-response-builder
  "Creates a  `CfnIntegrationResponse$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-integration-response-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `responseParameters` | java.util.List | [[cdk.support/lookup-entry]] | `:response-parameters` |
"
...
(defn cfn-integration-response-parameter-list-property-builder
  "Creates a  `CfnIntegration$ResponseParameterListProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-integration-response-parameter-list-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-integration-response-parameter-property-builder
  "Creates a  `CfnIntegration$ResponseParameterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-integration-response-parameter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-integration-response-props-builder
  "Creates a  `CfnIntegrationResponseProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-integration-response-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-integration-tls-config-property-builder
  "Creates a  `CfnIntegration$TlsConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-integration-tls-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-route-parameter-constraints-property-builder
  "Creates a  `CfnRoute$ParameterConstraintsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-route-parameter-constraints-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-route-response-builder
  "Creates a  `CfnRouteResponse$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-route-response-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-route-response-parameter-constraints-property-builder
  "Creates a  `CfnRouteResponse$ParameterConstraintsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-route-response-parameter-constraints-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-route-response-props-builder
  "Creates a  `CfnRouteResponseProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-route-response-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-stage-access-log-settings-property-builder
  "Creates a  `CfnStage$AccessLogSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-stage-access-log-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-stage-route-settings-property-builder
  "Creates a  `CfnStage$RouteSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-stage-route-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cors-preflight-options-builder
  "Creates a  `CorsPreflightOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[cors-preflight-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn domain-mapping-options-builder
  "Creates a  `DomainMappingOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[domain-mapping-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn endpoint-options-builder
  "Creates a  `EndpointOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[endpoint-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn grant-invoke-options-builder
  "Creates a  `GrantInvokeOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[grant-invoke-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-api-attributes-builder
  "Creates a  `HttpApiAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-api-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-api-builder
  "Creates a  `HttpApi$Builder` instance using a scope and ID, applies the data configuration using the [[http-api-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn http-api-props-builder
  "Creates a  `HttpApiProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-api-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-authorizer-attributes-builder
  "Creates a  `HttpAuthorizerAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-authorizer-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-authorizer-builder
  "Creates a  `HttpAuthorizer$Builder` instance using a scope and ID, applies the data configuration using the [[http-authorizer-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn http-authorizer-props-builder
  "Creates a  `HttpAuthorizerProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-authorizer-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-integration-builder
  "Creates a  `HttpIntegration$Builder` instance using a scope and ID, applies the data configuration using the [[http-integration-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn http-route-authorizer-bind-options-builder
  "Creates a  `HttpRouteAuthorizerBindOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-route-authorizer-bind-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-route-authorizer-config-builder
  "Creates a  `HttpRouteAuthorizerConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-route-authorizer-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-route-builder
  "Creates a  `HttpRoute$Builder` instance using a scope and ID, applies the data configuration using the [[http-route-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn http-route-integration-bind-options-builder
  "Creates a  `HttpRouteIntegrationBindOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-route-integration-bind-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-route-integration-config-builder
  "Creates a  `HttpRouteIntegrationConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-route-integration-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-route-props-builder
  "Creates a  `HttpRouteProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-route-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-stage-attributes-builder
  "Creates a  `HttpStageAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-stage-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-stage-builder
  "Creates a  `HttpStage$Builder` instance using a scope and ID, applies the data configuration using the [[http-stage-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn http-stage-options-builder
  "Creates a  `HttpStageOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-stage-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn http-stage-props-builder
  "Creates a  `HttpStageProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[http-stage-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn vpc-link-attributes-builder
  "Creates a  `VpcLinkAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[vpc-link-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-api-attributes-builder
  "Creates a  `WebSocketApiAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-api-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-api-builder
  "Creates a  `WebSocketApi$Builder` instance using a scope and ID, applies the data configuration using the [[web-socket-api-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn web-socket-api-props-builder
  "Creates a  `WebSocketApiProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-api-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-authorizer-attributes-builder
  "Creates a  `WebSocketAuthorizerAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-authorizer-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-authorizer-builder
  "Creates a  `WebSocketAuthorizer$Builder` instance using a scope and ID, applies the data configuration using the [[web-socket-authorizer-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn web-socket-authorizer-props-builder
  "Creates a  `WebSocketAuthorizerProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-authorizer-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-integration-builder
  "Creates a  `WebSocketIntegration$Builder` instance using a scope and ID, applies the data configuration using the [[web-socket-integration-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn web-socket-integration-props-builder
  "Creates a  `WebSocketIntegrationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-integration-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-route-authorizer-bind-options-builder
  "Creates a  `WebSocketRouteAuthorizerBindOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-route-authorizer-bind-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-route-authorizer-config-builder
  "Creates a  `WebSocketRouteAuthorizerConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-route-authorizer-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-route-builder
  "Creates a  `WebSocketRoute$Builder` instance using a scope and ID, applies the data configuration using the [[web-socket-route-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn web-socket-route-integration-bind-options-builder
  "Creates a  `WebSocketRouteIntegrationBindOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-route-integration-bind-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-route-integration-config-builder
  "Creates a  `WebSocketRouteIntegrationConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-route-integration-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-route-options-builder
  "Creates a  `WebSocketRouteOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-route-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-route-props-builder
  "Creates a  `WebSocketRouteProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-route-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-stage-attributes-builder
  "Creates a  `WebSocketStageAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-stage-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn web-socket-stage-builder
  "Creates a  `WebSocketStage$Builder` instance using a scope and ID, applies the data configuration using the [[web-socket-stage-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn web-socket-stage-props-builder
  "Creates a  `WebSocketStageProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[web-socket-stage-props-builder>]] function, then builds it.  Takes the following arguments: 
