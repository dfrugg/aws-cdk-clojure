...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `excludedTimeRanges` | java.util.List | [[cdk.support/lookup-entry]] | `:excluded-time-ranges` |
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `periodicSpikes` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:periodic-spikes` |
"
