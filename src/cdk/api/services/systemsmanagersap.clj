...
(defn cfn-application-credential-property-builder
  "Creates a  `CfnApplication$CredentialProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-application-credential-property-builder>]] function, then builds it.  Takes the following arguments: 
