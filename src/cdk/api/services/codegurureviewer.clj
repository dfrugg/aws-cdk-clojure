...
(defn cfn-repository-association-builder
  "Creates a  `CfnRepositoryAssociation$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-repository-association-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-repository-association-props-builder
  "Creates a  `CfnRepositoryAssociationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-repository-association-props-builder>]] function, then builds it.  Takes the following arguments: 
