...
(defn cfn-billing-group-account-grouping-property-builder
  "Creates a  `CfnBillingGroup$AccountGroupingProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-billing-group-account-grouping-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-billing-group-computation-preference-property-builder
  "Creates a  `CfnBillingGroup$ComputationPreferenceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-billing-group-computation-preference-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-line-item-billing-period-range-property-builder
  "Creates a  `CfnCustomLineItem$BillingPeriodRangeProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-line-item-billing-period-range-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-line-item-builder
  "Creates a  `CfnCustomLineItem$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-custom-line-item-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-custom-line-item-custom-line-item-charge-details-property-builder
  "Creates a  `CfnCustomLineItem$CustomLineItemChargeDetailsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-line-item-custom-line-item-charge-details-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-line-item-custom-line-item-flat-charge-details-property-builder
  "Creates a  `CfnCustomLineItem$CustomLineItemFlatChargeDetailsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-line-item-custom-line-item-flat-charge-details-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-line-item-custom-line-item-percentage-charge-details-property-builder
  "Creates a  `CfnCustomLineItem$CustomLineItemPercentageChargeDetailsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-line-item-custom-line-item-percentage-charge-details-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-line-item-line-item-filter-property-builder
  "Creates a  `CfnCustomLineItem$LineItemFilterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-line-item-line-item-filter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-line-item-props-builder
  "Creates a  `CfnCustomLineItemProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-line-item-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-pricing-plan-builder
  "Creates a  `CfnPricingPlan$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-pricing-plan-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-pricing-plan-props-builder
  "Creates a  `CfnPricingPlanProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-pricing-plan-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-pricing-rule-builder
  "Creates a  `CfnPricingRule$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-pricing-rule-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-pricing-rule-free-tier-property-builder
  "Creates a  `CfnPricingRule$FreeTierProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-pricing-rule-free-tier-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-pricing-rule-props-builder
  "Creates a  `CfnPricingRuleProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-pricing-rule-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-pricing-rule-tiering-property-builder
  "Creates a  `CfnPricingRule$TieringProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-pricing-rule-tiering-property-builder>]] function, then builds it.  Takes the following arguments: 
