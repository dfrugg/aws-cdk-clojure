...
(defn cfn-zonal-autoshift-configuration-builder
  "Creates a  `CfnZonalAutoshiftConfiguration$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-zonal-autoshift-configuration-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-zonal-autoshift-configuration-control-condition-property-builder
  "Creates a  `CfnZonalAutoshiftConfiguration$ControlConditionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-zonal-autoshift-configuration-control-condition-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-zonal-autoshift-configuration-practice-run-configuration-property-builder
  "Creates a  `CfnZonalAutoshiftConfiguration$PracticeRunConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-zonal-autoshift-configuration-practice-run-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-zonal-autoshift-configuration-props-builder
  "Creates a  `CfnZonalAutoshiftConfigurationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-zonal-autoshift-configuration-props-builder>]] function, then builds it.  Takes the following arguments: 
