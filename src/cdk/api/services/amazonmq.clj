...
(defn cfn-broker-builder
  "Creates a  `CfnBroker$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-broker-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-configuration-id-property-builder
  "Creates a  `CfnBroker$ConfigurationIdProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-configuration-id-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-encryption-options-property-builder
  "Creates a  `CfnBroker$EncryptionOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-encryption-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-ldap-server-metadata-property-builder
  "Creates a  `CfnBroker$LdapServerMetadataProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-ldap-server-metadata-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-log-list-property-builder
  "Creates a  `CfnBroker$LogListProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-log-list-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-maintenance-window-property-builder
  "Creates a  `CfnBroker$MaintenanceWindowProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-maintenance-window-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-props-builder
  "Creates a  `CfnBrokerProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-tags-entry-property-builder
  "Creates a  `CfnBroker$TagsEntryProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-tags-entry-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-broker-user-property-builder
  "Creates a  `CfnBroker$UserProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-broker-user-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-association-builder
  "Creates a  `CfnConfigurationAssociation$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-configuration-association-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-configuration-association-configuration-id-property-builder
  "Creates a  `CfnConfigurationAssociation$ConfigurationIdProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-association-configuration-id-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-association-props-builder
  "Creates a  `CfnConfigurationAssociationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-association-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-tags-entry-property-builder
  "Creates a  `CfnConfiguration$TagsEntryProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-tags-entry-property-builder>]] function, then builds it.  Takes the following arguments: 
