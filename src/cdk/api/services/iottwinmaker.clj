...
(defn cfn-component-type-builder>
  "The cfn-component-type-builder> function updates a CfnComponentType$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :component-type-id)]
    (. builder componentTypeId data))
  (when-some [data (lookup-entry config id :composite-component-types)]
    (. builder compositeComponentTypes data))
  (when-some [data (lookup-entry config id :description)]
    (. builder description data))
  (when-some [data (lookup-entry config id :extends-from)]
    (. builder extendsFrom data))
  (when-some [data (lookup-entry config id :functions)]
    (. builder functions data))
  (when-some [data (lookup-entry config id :is-singleton)]
    (. builder isSingleton data))
  (when-some [data (lookup-entry config id :property-definitions)]
    (. builder propertyDefinitions data))
  (when-some [data (lookup-entry config id :property-groups)]
    (. builder propertyGroups data))
  (when-some [data (lookup-entry config id :tags)]
    (. builder tags data))
  (when-some [data (lookup-entry config id :workspace-id)]
    (. builder workspaceId data))
  (.build builder))


(defn cfn-component-type-builder
  "Creates a  `CfnComponentType$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-component-type-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  ...
  (cfn-component-type-builder> (CfnComponentType$Builder/create scope (name id)) id config))


(defn cfn-component-type-composite-component-type-property-builder>
  "The cfn-component-type-composite-component-type-property-builder> function updates a CfnComponentType$CompositeComponentTypeProperty$Builder instance using the provided configuration.
...
(defn cfn-component-type-composite-component-type-property-builder
  "Creates a  `CfnComponentType$CompositeComponentTypeProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-composite-component-type-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-composite-component-type-property-builder> (new CfnComponentType$CompositeComponentTypeProperty$Builder) id config))


(defn cfn-component-type-data-connector-property-builder>
  "The cfn-component-type-data-connector-property-builder> function updates a CfnComponentType$DataConnectorProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :is-native)]
...
(defn cfn-component-type-data-connector-property-builder
  "Creates a  `CfnComponentType$DataConnectorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-data-connector-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-data-connector-property-builder> (new CfnComponentType$DataConnectorProperty$Builder) id config))


(defn cfn-component-type-data-type-property-builder>
  "The cfn-component-type-data-type-property-builder> function updates a CfnComponentType$DataTypeProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :nested-type)]
    (. builder nestedType data))
  (when-some [data (lookup-entry config id :relationship)]
    (. builder relationship data))
  (when-some [data (lookup-entry config id :type)]
    (. builder type data))
  (when-some [data (lookup-entry config id :unit-of-measure)]
    (. builder unitOfMeasure data))
  (.build builder))


(defn cfn-component-type-data-type-property-builder
  "Creates a  `CfnComponentType$DataTypeProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-data-type-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-data-type-property-builder> (new CfnComponentType$DataTypeProperty$Builder) id config))


(defn cfn-component-type-data-value-property-builder>
  "The cfn-component-type-data-value-property-builder> function updates a CfnComponentType$DataValueProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :list-value)]
    (. builder listValue data))
  (when-some [data (lookup-entry config id :long-value)]
    (. builder longValue data))
  (when-some [data (lookup-entry config id :map-value)]
    (. builder mapValue data))
  (when-some [data (lookup-entry config id :relationship-value)]
...
(defn cfn-component-type-data-value-property-builder
  "Creates a  `CfnComponentType$DataValueProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-data-value-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-data-value-property-builder> (new CfnComponentType$DataValueProperty$Builder) id config))


(defn cfn-component-type-error-property-builder>
  "The cfn-component-type-error-property-builder> function updates a CfnComponentType$ErrorProperty$Builder instance using the provided configuration.
...
(defn cfn-component-type-error-property-builder
  "Creates a  `CfnComponentType$ErrorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-error-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-error-property-builder> (new CfnComponentType$ErrorProperty$Builder) id config))


(defn cfn-component-type-function-property-builder>
  "The cfn-component-type-function-property-builder> function updates a CfnComponentType$FunctionProperty$Builder instance using the provided configuration.
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `implementedBy` | software.amazon.awscdk.services.iottwinmaker.CfnComponentType$DataConnectorProperty | [[cdk.support/lookup-entry]] | `:implemented-by` |
...
"
  ...
  (when-some [data (lookup-entry config id :implemented-by)]
    (. builder implementedBy data))
  (when-some [data (lookup-entry config id :required-properties)]
...
(defn cfn-component-type-function-property-builder
  "Creates a  `CfnComponentType$FunctionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-function-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-function-property-builder> (new CfnComponentType$FunctionProperty$Builder) id config))


(defn cfn-component-type-lambda-function-property-builder>
  "The cfn-component-type-lambda-function-property-builder> function updates a CfnComponentType$LambdaFunctionProperty$Builder instance using the provided configuration.
...
(defn cfn-component-type-lambda-function-property-builder
  "Creates a  `CfnComponentType$LambdaFunctionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-lambda-function-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-lambda-function-property-builder> (new CfnComponentType$LambdaFunctionProperty$Builder) id config))


(defn cfn-component-type-property-definition-property-builder>
  "The cfn-component-type-property-definition-property-builder> function updates a CfnComponentType$PropertyDefinitionProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :is-external-id)]
    (. builder isExternalId data))
  (when-some [data (lookup-entry config id :is-required-in-entity)]
    (. builder isRequiredInEntity data))
  (when-some [data (lookup-entry config id :is-stored-externally)]
    (. builder isStoredExternally data))
  (when-some [data (lookup-entry config id :is-time-series)]
    (. builder isTimeSeries data))
  (.build builder))


(defn cfn-component-type-property-definition-property-builder
  "Creates a  `CfnComponentType$PropertyDefinitionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-property-definition-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-property-definition-property-builder> (new CfnComponentType$PropertyDefinitionProperty$Builder) id config))


(defn cfn-component-type-property-group-property-builder>
  "The cfn-component-type-property-group-property-builder> function updates a CfnComponentType$PropertyGroupProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :group-type)]
...
(defn cfn-component-type-property-group-property-builder
  "Creates a  `CfnComponentType$PropertyGroupProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-property-group-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-property-group-property-builder> (new CfnComponentType$PropertyGroupProperty$Builder) id config))


(defn cfn-component-type-props-builder>
  "The cfn-component-type-props-builder> function updates a CfnComponentTypeProps$Builder instance using the provided configuration.
...
(defn cfn-component-type-props-builder
  "Creates a  `CfnComponentTypeProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-props-builder> (new CfnComponentTypeProps$Builder) id config))


(defn cfn-component-type-relationship-property-builder>
  "The cfn-component-type-relationship-property-builder> function updates a CfnComponentType$RelationshipProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :relationship-type)]
    (. builder relationshipType data))
  (when-some [data (lookup-entry config id :target-component-type-id)]
    (. builder targetComponentTypeId data))
  (.build builder))


(defn cfn-component-type-relationship-property-builder
  "Creates a  `CfnComponentType$RelationshipProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-relationship-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-relationship-property-builder> (new CfnComponentType$RelationshipProperty$Builder) id config))


(defn cfn-component-type-relationship-value-property-builder>
  "The cfn-component-type-relationship-value-property-builder> function updates a CfnComponentType$RelationshipValueProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :target-component-name)]
    (. builder targetComponentName data))
  (when-some [data (lookup-entry config id :target-entity-id)]
    (. builder targetEntityId data))
  (.build builder))


(defn cfn-component-type-relationship-value-property-builder
  "Creates a  `CfnComponentType$RelationshipValueProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-relationship-value-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-relationship-value-property-builder> (new CfnComponentType$RelationshipValueProperty$Builder) id config))


(defn cfn-component-type-status-property-builder>
  "The cfn-component-type-status-property-builder> function updates a CfnComponentType$StatusProperty$Builder instance using the provided configuration.
...
(defn cfn-component-type-status-property-builder
  "Creates a  `CfnComponentType$StatusProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-component-type-status-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-component-type-status-property-builder> (new CfnComponentType$StatusProperty$Builder) id config))


(defn cfn-entity-builder>
  "The cfn-entity-builder> function updates a CfnEntity$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :composite-components)]
  ...
  (when-some [data (lookup-entry config id :parent-entity-id)]
...
(defn cfn-entity-builder
  "Creates a  `CfnEntity$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-entity-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-entity-builder> (CfnEntity$Builder/create scope (name id)) id config))


(defn cfn-entity-component-property-builder>
  "The cfn-entity-component-property-builder> function updates a CfnEntity$ComponentProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :component-type-id)]
    (. builder componentTypeId data))
  (when-some [data (lookup-entry config id :defined-in)]
...
(defn cfn-entity-component-property-builder
  "Creates a  `CfnEntity$ComponentProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-component-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-component-property-builder> (new CfnEntity$ComponentProperty$Builder) id config))


(defn cfn-entity-composite-component-property-builder>
  "The cfn-entity-composite-component-property-builder> function updates a CfnEntity$CompositeComponentProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :component-name)]
    (. builder componentName data))
  (when-some [data (lookup-entry config id :component-path)]
...
(defn cfn-entity-composite-component-property-builder
  "Creates a  `CfnEntity$CompositeComponentProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-composite-component-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-composite-component-property-builder> (new CfnEntity$CompositeComponentProperty$Builder) id config))


(defn cfn-entity-data-type-property-builder>
  "The cfn-entity-data-type-property-builder> function updates a CfnEntity$DataTypeProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-data-type-property-builder
  "Creates a  `CfnEntity$DataTypeProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-data-type-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-data-type-property-builder> (new CfnEntity$DataTypeProperty$Builder) id config))


(defn cfn-entity-data-value-property-builder>
  "The cfn-entity-data-value-property-builder> function updates a CfnEntity$DataValueProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-data-value-property-builder
  "Creates a  `CfnEntity$DataValueProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-data-value-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-data-value-property-builder> (new CfnEntity$DataValueProperty$Builder) id config))


(defn cfn-entity-definition-property-builder>
  "The cfn-entity-definition-property-builder> function updates a CfnEntity$DefinitionProperty$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :is-external-id)]
    (. builder isExternalId data))
  (when-some [data (lookup-entry config id :is-final)]
    (. builder isFinal data))
  (when-some [data (lookup-entry config id :is-imported)]
    (. builder isImported data))
  (when-some [data (lookup-entry config id :is-inherited)]
...
(defn cfn-entity-definition-property-builder
  "Creates a  `CfnEntity$DefinitionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-definition-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-definition-property-builder> (new CfnEntity$DefinitionProperty$Builder) id config))


(defn cfn-entity-error-property-builder>
  "The cfn-entity-error-property-builder> function updates a CfnEntity$ErrorProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-error-property-builder
  "Creates a  `CfnEntity$ErrorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-error-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-error-property-builder> (new CfnEntity$ErrorProperty$Builder) id config))


(defn cfn-entity-property-group-property-builder>
  "The cfn-entity-property-group-property-builder> function updates a CfnEntity$PropertyGroupProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-property-group-property-builder
  "Creates a  `CfnEntity$PropertyGroupProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-property-group-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-property-group-property-builder> (new CfnEntity$PropertyGroupProperty$Builder) id config))


(defn cfn-entity-property-property-builder>
  "The cfn-entity-property-property-builder> function updates a CfnEntity$PropertyProperty$Builder instance using the provided configuration.
...
| `value` | software.amazon.awscdk.services.iottwinmaker.CfnEntity$DataValueProperty | [[cdk.support/lookup-entry]] | `:value` |
"
...
(defn cfn-entity-property-property-builder
  "Creates a  `CfnEntity$PropertyProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-property-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-property-property-builder> (new CfnEntity$PropertyProperty$Builder) id config))


(defn cfn-entity-props-builder>
  "The cfn-entity-props-builder> function updates a CfnEntityProps$Builder instance using the provided configuration.
...
(defn cfn-entity-props-builder
  "Creates a  `CfnEntityProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-props-builder> (new CfnEntityProps$Builder) id config))


(defn cfn-entity-relationship-property-builder>
  "The cfn-entity-relationship-property-builder> function updates a CfnEntity$RelationshipProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-relationship-property-builder
  "Creates a  `CfnEntity$RelationshipProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-relationship-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-relationship-property-builder> (new CfnEntity$RelationshipProperty$Builder) id config))


(defn cfn-entity-relationship-value-property-builder>
  "The cfn-entity-relationship-value-property-builder> function updates a CfnEntity$RelationshipValueProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-relationship-value-property-builder
  "Creates a  `CfnEntity$RelationshipValueProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-relationship-value-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-relationship-value-property-builder> (new CfnEntity$RelationshipValueProperty$Builder) id config))


(defn cfn-entity-status-property-builder>
  "The cfn-entity-status-property-builder> function updates a CfnEntity$StatusProperty$Builder instance using the provided configuration.
...
(defn cfn-entity-status-property-builder
  "Creates a  `CfnEntity$StatusProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-entity-status-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-entity-status-property-builder> (new CfnEntity$StatusProperty$Builder) id config))


(defn cfn-scene-builder>
  "The cfn-scene-builder> function updates a CfnScene$Builder instance using the provided configuration.
...
| `sceneMetadata` | java.util.Map | [[cdk.support/lookup-entry]] | `:scene-metadata` |
| `tags` | java.util.Map | [[cdk.support/lookup-entry]] | `:tags` |
| `workspaceId` | java.lang.String | [[cdk.support/lookup-entry]] | `:workspace-id` |
"
  ...
  (when-some [data (lookup-entry config id :content-location)]
    (. builder contentLocation data))
  (when-some [data (lookup-entry config id :description)]
    (. builder description data))
  (when-some [data (lookup-entry config id :scene-id)]
    (. builder sceneId data))
  (when-some [data (lookup-entry config id :scene-metadata)]
...
(defn cfn-scene-builder
  "Creates a  `CfnScene$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-scene-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-scene-builder> (CfnScene$Builder/create scope (name id)) id config))


(defn cfn-scene-props-builder>
  "The cfn-scene-props-builder> function updates a CfnSceneProps$Builder instance using the provided configuration.
...
(defn cfn-scene-props-builder
  "Creates a  `CfnSceneProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scene-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-scene-props-builder> (new CfnSceneProps$Builder) id config))


(defn cfn-sync-job-builder>
  "The cfn-sync-job-builder> function updates a CfnSyncJob$Builder instance using the provided configuration.
...
"
  ...
  (when-some [data (lookup-entry config id :sync-role)]
...
(defn cfn-sync-job-builder
  "Creates a  `CfnSyncJob$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-sync-job-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-sync-job-builder> (CfnSyncJob$Builder/create scope (name id)) id config))


(defn cfn-sync-job-props-builder>
  "The cfn-sync-job-props-builder> function updates a CfnSyncJobProps$Builder instance using the provided configuration.
...
(defn cfn-sync-job-props-builder
  "Creates a  `CfnSyncJobProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-sync-job-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-sync-job-props-builder> (new CfnSyncJobProps$Builder) id config))
