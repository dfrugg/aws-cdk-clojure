...
(defn cfn-data-provider-builder
  "Creates a  `CfnDataProvider$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-data-provider-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-data-provider-props-builder
  "Creates a  `CfnDataProviderProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-data-provider-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-doc-db-settings-property-builder
  "Creates a  `CfnEndpoint$DocDbSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-doc-db-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-dynamo-db-settings-property-builder
  "Creates a  `CfnEndpoint$DynamoDbSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-dynamo-db-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-elasticsearch-settings-property-builder
  "Creates a  `CfnEndpoint$ElasticsearchSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-elasticsearch-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-gcp-my-sql-settings-property-builder
  "Creates a  `CfnEndpoint$GcpMySQLSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-gcp-my-sql-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-ibm-db2-settings-property-builder
  "Creates a  `CfnEndpoint$IbmDb2SettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-ibm-db2-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-kafka-settings-property-builder
  "Creates a  `CfnEndpoint$KafkaSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-kafka-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-kinesis-settings-property-builder
  "Creates a  `CfnEndpoint$KinesisSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-kinesis-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `password` | java.lang.String | [[cdk.support/lookup-entry]] | `:password` |
| `port` | java.lang.Number | [[cdk.support/lookup-entry]] | `:port` |
| `querySingleAlwaysOnNode` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:query-single-always-on-node` |
| `readBackupOnly` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:read-backup-only` |
...
| `useThirdPartyBackupDevice` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:use-third-party-backup-device` |
| `username` | java.lang.String | [[cdk.support/lookup-entry]] | `:username` |
"
...
(defn cfn-endpoint-microsoft-sql-server-settings-property-builder
  "Creates a  `CfnEndpoint$MicrosoftSqlServerSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-microsoft-sql-server-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-mongo-db-settings-property-builder
  "Creates a  `CfnEndpoint$MongoDbSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-mongo-db-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-my-sql-settings-property-builder
  "Creates a  `CfnEndpoint$MySqlSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-my-sql-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-neptune-settings-property-builder
  "Creates a  `CfnEndpoint$NeptuneSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-neptune-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `useDirectPathFullLoad` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:use-direct-path-full-load` |
...
(defn cfn-endpoint-oracle-settings-property-builder
  "Creates a  `CfnEndpoint$OracleSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-oracle-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `failTasksOnLobTruncation` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:fail-tasks-on-lob-truncation` |
| `heartbeatEnable` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:heartbeat-enable` |
...
(defn cfn-endpoint-postgre-sql-settings-property-builder
  "Creates a  `CfnEndpoint$PostgreSqlSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-postgre-sql-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-redis-settings-property-builder
  "Creates a  `CfnEndpoint$RedisSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-redis-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `trimBlanks` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:trim-blanks` |
...
(defn cfn-endpoint-redshift-settings-property-builder
  "Creates a  `CfnEndpoint$RedshiftSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-redshift-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `addColumnName` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:add-column-name` |
...
| `glueCatalogGeneration` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:glue-catalog-generation` |
...
| `rfc4180` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:rfc4180` |
...
(defn cfn-endpoint-s3-settings-property-builder
  "Creates a  `CfnEndpoint$S3SettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-s3-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-endpoint-sybase-settings-property-builder
  "Creates a  `CfnEndpoint$SybaseSettingsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-endpoint-sybase-settings-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-migration-project-builder
  "Creates a  `CfnMigrationProject$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-migration-project-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-migration-project-data-provider-descriptor-property-builder
  "Creates a  `CfnMigrationProject$DataProviderDescriptorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-migration-project-data-provider-descriptor-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-migration-project-props-builder
  "Creates a  `CfnMigrationProjectProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-migration-project-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-migration-project-schema-conversion-application-attributes-property-builder
  "Creates a  `CfnMigrationProject$SchemaConversionApplicationAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-migration-project-schema-conversion-application-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-replication-config-builder
  "Creates a  `CfnReplicationConfig$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-replication-config-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-replication-config-compute-config-property-builder
  "Creates a  `CfnReplicationConfig$ComputeConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-replication-config-compute-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-replication-config-props-builder
  "Creates a  `CfnReplicationConfigProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-replication-config-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-replication-instance-builder
  "Creates a  `CfnReplicationInstance$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-replication-instance-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-replication-instance-props-builder
  "Creates a  `CfnReplicationInstanceProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-replication-instance-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-replication-subnet-group-builder
  "Creates a  `CfnReplicationSubnetGroup$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-replication-subnet-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-replication-subnet-group-props-builder
  "Creates a  `CfnReplicationSubnetGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-replication-subnet-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-replication-task-builder
  "Creates a  `CfnReplicationTask$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-replication-task-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-replication-task-props-builder
  "Creates a  `CfnReplicationTaskProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-replication-task-props-builder>]] function, then builds it.  Takes the following arguments: 
