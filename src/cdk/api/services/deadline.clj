...
| `acceleratorTotalMemoryMiB` | software.amazon.awscdk.services.deadline.CfnFleet$AcceleratorTotalMemoryMiBRangeProperty | [[cdk.support/lookup-entry]] | `:accelerator-total-memory-mi-b` |
...
| `jobRunAsUser` | software.amazon.awscdk.services.deadline.CfnQueue$JobRunAsUserProperty | [[cdk.support/lookup-entry]] | `:job-run-as-user` |
...
| `windows` | software.amazon.awscdk.services.deadline.CfnQueue$WindowsUserProperty | [[cdk.support/lookup-entry]] | `:windows` |
"
