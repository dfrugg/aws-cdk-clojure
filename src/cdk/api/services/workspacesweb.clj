...
(defn cfn-browser-settings-builder>
  "The cfn-browser-settings-builder> function updates a CfnBrowserSettings$Builder instance using the provided configuration.
...
(defn cfn-browser-settings-builder
  "Creates a  `CfnBrowserSettings$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-browser-settings-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  ...
  (cfn-browser-settings-builder> (CfnBrowserSettings$Builder/create scope (name id)) id config))


(defn cfn-browser-settings-props-builder>
  "The cfn-browser-settings-props-builder> function updates a CfnBrowserSettingsProps$Builder instance using the provided configuration.
...
(defn cfn-browser-settings-props-builder
  "Creates a  `CfnBrowserSettingsProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-browser-settings-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-browser-settings-props-builder> (new CfnBrowserSettingsProps$Builder) id config))


(defn cfn-identity-provider-builder>
  "The cfn-identity-provider-builder> function updates a CfnIdentityProvider$Builder instance using the provided configuration.
...
(defn cfn-identity-provider-builder
  "Creates a  `CfnIdentityProvider$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-identity-provider-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-identity-provider-builder> (CfnIdentityProvider$Builder/create scope (name id)) id config))


(defn cfn-identity-provider-props-builder>
  "The cfn-identity-provider-props-builder> function updates a CfnIdentityProviderProps$Builder instance using the provided configuration.
...
(defn cfn-identity-provider-props-builder
  "Creates a  `CfnIdentityProviderProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-identity-provider-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-identity-provider-props-builder> (new CfnIdentityProviderProps$Builder) id config))


(defn cfn-ip-access-settings-builder>
  "The cfn-ip-access-settings-builder> function updates a CfnIpAccessSettings$Builder instance using the provided configuration.
...
(defn cfn-ip-access-settings-builder
  "Creates a  `CfnIpAccessSettings$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-ip-access-settings-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-ip-access-settings-builder> (CfnIpAccessSettings$Builder/create scope (name id)) id config))


(defn cfn-ip-access-settings-ip-rule-property-builder>
  "The cfn-ip-access-settings-ip-rule-property-builder> function updates a CfnIpAccessSettings$IpRuleProperty$Builder instance using the provided configuration.
...
(defn cfn-ip-access-settings-ip-rule-property-builder
  "Creates a  `CfnIpAccessSettings$IpRuleProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-ip-access-settings-ip-rule-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-ip-access-settings-ip-rule-property-builder> (new CfnIpAccessSettings$IpRuleProperty$Builder) id config))


(defn cfn-ip-access-settings-props-builder>
  "The cfn-ip-access-settings-props-builder> function updates a CfnIpAccessSettingsProps$Builder instance using the provided configuration.
...
(defn cfn-ip-access-settings-props-builder
  "Creates a  `CfnIpAccessSettingsProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-ip-access-settings-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-ip-access-settings-props-builder> (new CfnIpAccessSettingsProps$Builder) id config))


(defn cfn-network-settings-builder>
  "The cfn-network-settings-builder> function updates a CfnNetworkSettings$Builder instance using the provided configuration.
...
(defn cfn-network-settings-builder
  "Creates a  `CfnNetworkSettings$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-network-settings-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-network-settings-builder> (CfnNetworkSettings$Builder/create scope (name id)) id config))


(defn cfn-network-settings-props-builder>
  "The cfn-network-settings-props-builder> function updates a CfnNetworkSettingsProps$Builder instance using the provided configuration.
...
(defn cfn-network-settings-props-builder
  "Creates a  `CfnNetworkSettingsProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-network-settings-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-network-settings-props-builder> (new CfnNetworkSettingsProps$Builder) id config))
...
(defn cfn-user-access-logging-settings-builder>
  "The cfn-user-access-logging-settings-builder> function updates a CfnUserAccessLoggingSettings$Builder instance using the provided configuration.
...
(defn cfn-user-access-logging-settings-builder
  "Creates a  `CfnUserAccessLoggingSettings$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-user-access-logging-settings-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-user-access-logging-settings-builder> (CfnUserAccessLoggingSettings$Builder/create scope (name id)) id config))


(defn cfn-user-access-logging-settings-props-builder>
  "The cfn-user-access-logging-settings-props-builder> function updates a CfnUserAccessLoggingSettingsProps$Builder instance using the provided configuration.
...
(defn cfn-user-access-logging-settings-props-builder
  "Creates a  `CfnUserAccessLoggingSettingsProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-user-access-logging-settings-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-user-access-logging-settings-props-builder> (new CfnUserAccessLoggingSettingsProps$Builder) id config))


(defn cfn-user-settings-builder>
  "The cfn-user-settings-builder> function updates a CfnUserSettings$Builder instance using the provided configuration.
...
(defn cfn-user-settings-builder
  "Creates a  `CfnUserSettings$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-user-settings-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-user-settings-builder> (CfnUserSettings$Builder/create scope (name id)) id config))


(defn cfn-user-settings-cookie-specification-property-builder>
  "The cfn-user-settings-cookie-specification-property-builder> function updates a CfnUserSettings$CookieSpecificationProperty$Builder instance using the provided configuration.
...
(defn cfn-user-settings-cookie-specification-property-builder
  "Creates a  `CfnUserSettings$CookieSpecificationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-user-settings-cookie-specification-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-user-settings-cookie-specification-property-builder> (new CfnUserSettings$CookieSpecificationProperty$Builder) id config))


(defn cfn-user-settings-cookie-synchronization-configuration-property-builder>
  "The cfn-user-settings-cookie-synchronization-configuration-property-builder> function updates a CfnUserSettings$CookieSynchronizationConfigurationProperty$Builder instance using the provided configuration.
...
(defn cfn-user-settings-cookie-synchronization-configuration-property-builder
  "Creates a  `CfnUserSettings$CookieSynchronizationConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-user-settings-cookie-synchronization-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-user-settings-cookie-synchronization-configuration-property-builder> (new CfnUserSettings$CookieSynchronizationConfigurationProperty$Builder) id config))


(defn cfn-user-settings-props-builder>
  "The cfn-user-settings-props-builder> function updates a CfnUserSettingsProps$Builder instance using the provided configuration.
...
(defn cfn-user-settings-props-builder
  "Creates a  `CfnUserSettingsProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-user-settings-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-user-settings-props-builder> (new CfnUserSettingsProps$Builder) id config))