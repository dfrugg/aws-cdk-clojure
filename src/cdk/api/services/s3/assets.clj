...
(defn asset-builder
  "Creates a  `Asset$Builder` instance using a scope and ID, applies the data configuration using the [[asset-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn asset-props-builder
  "Creates a  `AssetProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[asset-props-builder>]] function, then builds it.  Takes the following arguments: 
