...
(defn cfn-hypervisor-builder
  "Creates a  `CfnHypervisor$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-hypervisor-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-hypervisor-props-builder
  "Creates a  `CfnHypervisorProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-hypervisor-props-builder>]] function, then builds it.  Takes the following arguments: 
