...
(defn add-header-action-config-builder>
  "The add-header-action-config-builder> function updates a AddHeaderActionConfig$Builder instance using the provided configuration.
...
(defn add-header-action-config-builder
  "Creates a  `AddHeaderActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[add-header-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (add-header-action-config-builder> (new AddHeaderActionConfig$Builder) id config))


(defn allow-list-receipt-filter-builder>
  "The allow-list-receipt-filter-builder> function updates a AllowListReceiptFilter$Builder instance using the provided configuration.
...
(defn allow-list-receipt-filter-builder
  "Creates a  `AllowListReceiptFilter$Builder` instance using a scope and ID, applies the data configuration using the [[allow-list-receipt-filter-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
...
| `config` | map | Data configuration |"
  ...
  (allow-list-receipt-filter-builder> (AllowListReceiptFilter$Builder/create scope (name id)) id config))


(defn allow-list-receipt-filter-props-builder>
  "The allow-list-receipt-filter-props-builder> function updates a AllowListReceiptFilterProps$Builder instance using the provided configuration.
...
(defn allow-list-receipt-filter-props-builder
  "Creates a  `AllowListReceiptFilterProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[allow-list-receipt-filter-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (allow-list-receipt-filter-props-builder> (new AllowListReceiptFilterProps$Builder) id config))


(defn bounce-action-config-builder>
  "The bounce-action-config-builder> function updates a BounceActionConfig$Builder instance using the provided configuration.
...
(defn bounce-action-config-builder
  "Creates a  `BounceActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[bounce-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (bounce-action-config-builder> (new BounceActionConfig$Builder) id config))


(defn byo-dkim-options-builder>
  "The byo-dkim-options-builder> function updates a ByoDkimOptions$Builder instance using the provided configuration.
...
(defn byo-dkim-options-builder
  "Creates a  `ByoDkimOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[byo-dkim-options-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (byo-dkim-options-builder> (new ByoDkimOptions$Builder) id config))
...
(defn cfn-configuration-set-builder
  "Creates a  `CfnConfigurationSet$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-configuration-set-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-configuration-set-dashboard-options-property-builder>
  "The cfn-configuration-set-dashboard-options-property-builder> function updates a CfnConfigurationSet$DashboardOptionsProperty$Builder instance using the provided configuration.
...
(defn cfn-configuration-set-dashboard-options-property-builder
  "Creates a  `CfnConfigurationSet$DashboardOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-dashboard-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-configuration-set-dashboard-options-property-builder> (new CfnConfigurationSet$DashboardOptionsProperty$Builder) id config))
...
(defn cfn-configuration-set-delivery-options-property-builder
  "Creates a  `CfnConfigurationSet$DeliveryOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-delivery-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-event-destination-builder
  "Creates a  `CfnConfigurationSetEventDestination$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-configuration-set-event-destination-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-configuration-set-event-destination-cloud-watch-destination-property-builder
  "Creates a  `CfnConfigurationSetEventDestination$CloudWatchDestinationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-event-destination-cloud-watch-destination-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-event-destination-dimension-configuration-property-builder
  "Creates a  `CfnConfigurationSetEventDestination$DimensionConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-event-destination-dimension-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-event-destination-event-destination-property-builder
  "Creates a  `CfnConfigurationSetEventDestination$EventDestinationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-event-destination-event-destination-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-event-destination-kinesis-firehose-destination-property-builder
  "Creates a  `CfnConfigurationSetEventDestination$KinesisFirehoseDestinationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-event-destination-kinesis-firehose-destination-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-event-destination-props-builder
  "Creates a  `CfnConfigurationSetEventDestinationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-event-destination-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-event-destination-sns-destination-property-builder
  "Creates a  `CfnConfigurationSetEventDestination$SnsDestinationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-event-destination-sns-destination-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-guardian-options-property-builder>
  "The cfn-configuration-set-guardian-options-property-builder> function updates a CfnConfigurationSet$GuardianOptionsProperty$Builder instance using the provided configuration.
...
(defn cfn-configuration-set-guardian-options-property-builder
  "Creates a  `CfnConfigurationSet$GuardianOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-guardian-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-configuration-set-guardian-options-property-builder> (new CfnConfigurationSet$GuardianOptionsProperty$Builder) id config))
...
(defn cfn-configuration-set-props-builder
  "Creates a  `CfnConfigurationSetProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-reputation-options-property-builder
  "Creates a  `CfnConfigurationSet$ReputationOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-reputation-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-sending-options-property-builder
  "Creates a  `CfnConfigurationSet$SendingOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-sending-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-suppression-options-property-builder>
  "The cfn-configuration-set-suppression-options-property-builder> function updates a CfnConfigurationSet$SuppressionOptionsProperty$Builder instance using the provided configuration.
...
(defn cfn-configuration-set-suppression-options-property-builder
  "Creates a  `CfnConfigurationSet$SuppressionOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-suppression-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-configuration-set-suppression-options-property-builder> (new CfnConfigurationSet$SuppressionOptionsProperty$Builder) id config))
...
(defn cfn-configuration-set-tracking-options-property-builder
  "Creates a  `CfnConfigurationSet$TrackingOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-tracking-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-configuration-set-vdm-options-property-builder>
  "The cfn-configuration-set-vdm-options-property-builder> function updates a CfnConfigurationSet$VdmOptionsProperty$Builder instance using the provided configuration.
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `dashboardOptions` | software.amazon.awscdk.services.ses.CfnConfigurationSet$DashboardOptionsProperty | [[cdk.support/lookup-entry]] | `:dashboard-options` |
...
(defn cfn-configuration-set-vdm-options-property-builder
  "Creates a  `CfnConfigurationSet$VdmOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-configuration-set-vdm-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-configuration-set-vdm-options-property-builder> (new CfnConfigurationSet$VdmOptionsProperty$Builder) id config))


(defn cfn-contact-list-builder>
  "The cfn-contact-list-builder> function updates a CfnContactList$Builder instance using the provided configuration.
...
(defn cfn-contact-list-builder
  "Creates a  `CfnContactList$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-contact-list-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-contact-list-builder> (CfnContactList$Builder/create scope (name id)) id config))


(defn cfn-contact-list-props-builder>
  "The cfn-contact-list-props-builder> function updates a CfnContactListProps$Builder instance using the provided configuration.
...
(defn cfn-contact-list-props-builder
  "Creates a  `CfnContactListProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-contact-list-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-contact-list-props-builder> (new CfnContactListProps$Builder) id config))


(defn cfn-contact-list-topic-property-builder>
  "The cfn-contact-list-topic-property-builder> function updates a CfnContactList$TopicProperty$Builder instance using the provided configuration.
...
(defn cfn-contact-list-topic-property-builder
  "Creates a  `CfnContactList$TopicProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-contact-list-topic-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-contact-list-topic-property-builder> (new CfnContactList$TopicProperty$Builder) id config))
...
(defn cfn-dedicated-ip-pool-builder
  "Creates a  `CfnDedicatedIpPool$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-dedicated-ip-pool-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-dedicated-ip-pool-props-builder
  "Creates a  `CfnDedicatedIpPoolProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-dedicated-ip-pool-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-email-identity-builder>
  "The cfn-email-identity-builder> function updates a CfnEmailIdentity$Builder instance using the provided configuration.
...
(defn cfn-email-identity-builder
  "Creates a  `CfnEmailIdentity$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-email-identity-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-email-identity-builder> (CfnEmailIdentity$Builder/create scope (name id)) id config))


(defn cfn-email-identity-configuration-set-attributes-property-builder>
  "The cfn-email-identity-configuration-set-attributes-property-builder> function updates a CfnEmailIdentity$ConfigurationSetAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-email-identity-configuration-set-attributes-property-builder
  "Creates a  `CfnEmailIdentity$ConfigurationSetAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-email-identity-configuration-set-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-email-identity-configuration-set-attributes-property-builder> (new CfnEmailIdentity$ConfigurationSetAttributesProperty$Builder) id config))


(defn cfn-email-identity-dkim-attributes-property-builder>
  "The cfn-email-identity-dkim-attributes-property-builder> function updates a CfnEmailIdentity$DkimAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-email-identity-dkim-attributes-property-builder
  "Creates a  `CfnEmailIdentity$DkimAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-email-identity-dkim-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-email-identity-dkim-attributes-property-builder> (new CfnEmailIdentity$DkimAttributesProperty$Builder) id config))


(defn cfn-email-identity-dkim-signing-attributes-property-builder>
  "The cfn-email-identity-dkim-signing-attributes-property-builder> function updates a CfnEmailIdentity$DkimSigningAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-email-identity-dkim-signing-attributes-property-builder
  "Creates a  `CfnEmailIdentity$DkimSigningAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-email-identity-dkim-signing-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-email-identity-dkim-signing-attributes-property-builder> (new CfnEmailIdentity$DkimSigningAttributesProperty$Builder) id config))


(defn cfn-email-identity-feedback-attributes-property-builder>
  "The cfn-email-identity-feedback-attributes-property-builder> function updates a CfnEmailIdentity$FeedbackAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-email-identity-feedback-attributes-property-builder
  "Creates a  `CfnEmailIdentity$FeedbackAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-email-identity-feedback-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-email-identity-feedback-attributes-property-builder> (new CfnEmailIdentity$FeedbackAttributesProperty$Builder) id config))


(defn cfn-email-identity-mail-from-attributes-property-builder>
  "The cfn-email-identity-mail-from-attributes-property-builder> function updates a CfnEmailIdentity$MailFromAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-email-identity-mail-from-attributes-property-builder
  "Creates a  `CfnEmailIdentity$MailFromAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-email-identity-mail-from-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-email-identity-mail-from-attributes-property-builder> (new CfnEmailIdentity$MailFromAttributesProperty$Builder) id config))


(defn cfn-email-identity-props-builder>
  "The cfn-email-identity-props-builder> function updates a CfnEmailIdentityProps$Builder instance using the provided configuration.
...
(defn cfn-email-identity-props-builder
  "Creates a  `CfnEmailIdentityProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-email-identity-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-email-identity-props-builder> (new CfnEmailIdentityProps$Builder) id config))


(defn cfn-receipt-filter-builder>
  "The cfn-receipt-filter-builder> function updates a CfnReceiptFilter$Builder instance using the provided configuration.
...
(defn cfn-receipt-filter-builder
  "Creates a  `CfnReceiptFilter$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-receipt-filter-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-receipt-filter-builder> (CfnReceiptFilter$Builder/create scope (name id)) id config))


(defn cfn-receipt-filter-filter-property-builder>
  "The cfn-receipt-filter-filter-property-builder> function updates a CfnReceiptFilter$FilterProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-filter-filter-property-builder
  "Creates a  `CfnReceiptFilter$FilterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-filter-filter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-filter-filter-property-builder> (new CfnReceiptFilter$FilterProperty$Builder) id config))


(defn cfn-receipt-filter-ip-filter-property-builder>
  "The cfn-receipt-filter-ip-filter-property-builder> function updates a CfnReceiptFilter$IpFilterProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-filter-ip-filter-property-builder
  "Creates a  `CfnReceiptFilter$IpFilterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-filter-ip-filter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-filter-ip-filter-property-builder> (new CfnReceiptFilter$IpFilterProperty$Builder) id config))


(defn cfn-receipt-filter-props-builder>
  "The cfn-receipt-filter-props-builder> function updates a CfnReceiptFilterProps$Builder instance using the provided configuration.
...
(defn cfn-receipt-filter-props-builder
  "Creates a  `CfnReceiptFilterProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-filter-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-filter-props-builder> (new CfnReceiptFilterProps$Builder) id config))


(defn cfn-receipt-rule-action-property-builder>
  "The cfn-receipt-rule-action-property-builder> function updates a CfnReceiptRule$ActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-action-property-builder
  "Creates a  `CfnReceiptRule$ActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-action-property-builder> (new CfnReceiptRule$ActionProperty$Builder) id config))


(defn cfn-receipt-rule-add-header-action-property-builder>
  "The cfn-receipt-rule-add-header-action-property-builder> function updates a CfnReceiptRule$AddHeaderActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-add-header-action-property-builder
  "Creates a  `CfnReceiptRule$AddHeaderActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-add-header-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-add-header-action-property-builder> (new CfnReceiptRule$AddHeaderActionProperty$Builder) id config))


(defn cfn-receipt-rule-bounce-action-property-builder>
  "The cfn-receipt-rule-bounce-action-property-builder> function updates a CfnReceiptRule$BounceActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-bounce-action-property-builder
  "Creates a  `CfnReceiptRule$BounceActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-bounce-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-bounce-action-property-builder> (new CfnReceiptRule$BounceActionProperty$Builder) id config))


(defn cfn-receipt-rule-builder>
  "The cfn-receipt-rule-builder> function updates a CfnReceiptRule$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-builder
  "Creates a  `CfnReceiptRule$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-receipt-rule-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-receipt-rule-builder> (CfnReceiptRule$Builder/create scope (name id)) id config))


(defn cfn-receipt-rule-lambda-action-property-builder>
  "The cfn-receipt-rule-lambda-action-property-builder> function updates a CfnReceiptRule$LambdaActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-lambda-action-property-builder
  "Creates a  `CfnReceiptRule$LambdaActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-lambda-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-lambda-action-property-builder> (new CfnReceiptRule$LambdaActionProperty$Builder) id config))


(defn cfn-receipt-rule-props-builder>
  "The cfn-receipt-rule-props-builder> function updates a CfnReceiptRuleProps$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-props-builder
  "Creates a  `CfnReceiptRuleProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-props-builder> (new CfnReceiptRuleProps$Builder) id config))


(defn cfn-receipt-rule-rule-property-builder>
  "The cfn-receipt-rule-rule-property-builder> function updates a CfnReceiptRule$RuleProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-rule-property-builder
  "Creates a  `CfnReceiptRule$RuleProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-rule-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-rule-property-builder> (new CfnReceiptRule$RuleProperty$Builder) id config))


(defn cfn-receipt-rule-s3-action-property-builder>
  "The cfn-receipt-rule-s3-action-property-builder> function updates a CfnReceiptRule$S3ActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-s3-action-property-builder
  "Creates a  `CfnReceiptRule$S3ActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-s3-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-s3-action-property-builder> (new CfnReceiptRule$S3ActionProperty$Builder) id config))


(defn cfn-receipt-rule-set-builder>
  "The cfn-receipt-rule-set-builder> function updates a CfnReceiptRuleSet$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-set-builder
  "Creates a  `CfnReceiptRuleSet$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-receipt-rule-set-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-receipt-rule-set-builder> (CfnReceiptRuleSet$Builder/create scope (name id)) id config))


(defn cfn-receipt-rule-set-props-builder>
  "The cfn-receipt-rule-set-props-builder> function updates a CfnReceiptRuleSetProps$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-set-props-builder
  "Creates a  `CfnReceiptRuleSetProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-set-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-set-props-builder> (new CfnReceiptRuleSetProps$Builder) id config))


(defn cfn-receipt-rule-sns-action-property-builder>
  "The cfn-receipt-rule-sns-action-property-builder> function updates a CfnReceiptRule$SNSActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-sns-action-property-builder
  "Creates a  `CfnReceiptRule$SNSActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-sns-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-sns-action-property-builder> (new CfnReceiptRule$SNSActionProperty$Builder) id config))


(defn cfn-receipt-rule-stop-action-property-builder>
  "The cfn-receipt-rule-stop-action-property-builder> function updates a CfnReceiptRule$StopActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-stop-action-property-builder
  "Creates a  `CfnReceiptRule$StopActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-stop-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-stop-action-property-builder> (new CfnReceiptRule$StopActionProperty$Builder) id config))


(defn cfn-receipt-rule-workmail-action-property-builder>
  "The cfn-receipt-rule-workmail-action-property-builder> function updates a CfnReceiptRule$WorkmailActionProperty$Builder instance using the provided configuration.
...
(defn cfn-receipt-rule-workmail-action-property-builder
  "Creates a  `CfnReceiptRule$WorkmailActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-receipt-rule-workmail-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-receipt-rule-workmail-action-property-builder> (new CfnReceiptRule$WorkmailActionProperty$Builder) id config))


(defn cfn-template-builder>
  "The cfn-template-builder> function updates a CfnTemplate$Builder instance using the provided configuration.
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `template` | software.amazon.awscdk.services.ses.CfnTemplate$TemplateProperty | [[cdk.support/lookup-entry]] | `:template` |
"
...
(defn cfn-template-builder
  "Creates a  `CfnTemplate$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-template-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-template-builder> (CfnTemplate$Builder/create scope (name id)) id config))


(defn cfn-template-props-builder>
  "The cfn-template-props-builder> function updates a CfnTemplateProps$Builder instance using the provided configuration.
...
(defn cfn-template-props-builder
  "Creates a  `CfnTemplateProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-template-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-template-props-builder> (new CfnTemplateProps$Builder) id config))


(defn cfn-template-template-property-builder>
  "The cfn-template-template-property-builder> function updates a CfnTemplate$TemplateProperty$Builder instance using the provided configuration.
...
(defn cfn-template-template-property-builder
  "Creates a  `CfnTemplate$TemplateProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-template-template-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-template-template-property-builder> (new CfnTemplate$TemplateProperty$Builder) id config))


(defn cfn-vdm-attributes-builder>
  "The cfn-vdm-attributes-builder> function updates a CfnVdmAttributes$Builder instance using the provided configuration.
...
(defn cfn-vdm-attributes-builder
  "Creates a  `CfnVdmAttributes$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-vdm-attributes-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (cfn-vdm-attributes-builder> (CfnVdmAttributes$Builder/create scope (name id)) id config))


(defn cfn-vdm-attributes-dashboard-attributes-property-builder>
  "The cfn-vdm-attributes-dashboard-attributes-property-builder> function updates a CfnVdmAttributes$DashboardAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-vdm-attributes-dashboard-attributes-property-builder
  "Creates a  `CfnVdmAttributes$DashboardAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-vdm-attributes-dashboard-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-vdm-attributes-dashboard-attributes-property-builder> (new CfnVdmAttributes$DashboardAttributesProperty$Builder) id config))


(defn cfn-vdm-attributes-guardian-attributes-property-builder>
  "The cfn-vdm-attributes-guardian-attributes-property-builder> function updates a CfnVdmAttributes$GuardianAttributesProperty$Builder instance using the provided configuration.
...
(defn cfn-vdm-attributes-guardian-attributes-property-builder
  "Creates a  `CfnVdmAttributes$GuardianAttributesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-vdm-attributes-guardian-attributes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-vdm-attributes-guardian-attributes-property-builder> (new CfnVdmAttributes$GuardianAttributesProperty$Builder) id config))


(defn cfn-vdm-attributes-props-builder>
  "The cfn-vdm-attributes-props-builder> function updates a CfnVdmAttributesProps$Builder instance using the provided configuration.
...
(defn cfn-vdm-attributes-props-builder
  "Creates a  `CfnVdmAttributesProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-vdm-attributes-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cfn-vdm-attributes-props-builder> (new CfnVdmAttributesProps$Builder) id config))


(defn cloud-watch-dimension-builder>
  "The cloud-watch-dimension-builder> function updates a CloudWatchDimension$Builder instance using the provided configuration.
...
(defn cloud-watch-dimension-builder
  "Creates a  `CloudWatchDimension$Builder` instance using a no-argument constructor, applies the data configuration using the [[cloud-watch-dimension-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (cloud-watch-dimension-builder> (new CloudWatchDimension$Builder) id config))


(defn configuration-set-builder>
  "The configuration-set-builder> function updates a ConfigurationSet$Builder instance using the provided configuration.
...
(defn configuration-set-builder
  "Creates a  `ConfigurationSet$Builder` instance using a scope and ID, applies the data configuration using the [[configuration-set-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (configuration-set-builder> (ConfigurationSet$Builder/create scope (name id)) id config))


(defn configuration-set-event-destination-builder>
  "The configuration-set-event-destination-builder> function updates a ConfigurationSetEventDestination$Builder instance using the provided configuration.
...
(defn configuration-set-event-destination-builder
  "Creates a  `ConfigurationSetEventDestination$Builder` instance using a scope and ID, applies the data configuration using the [[configuration-set-event-destination-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (configuration-set-event-destination-builder> (ConfigurationSetEventDestination$Builder/create scope (name id)) id config))


(defn configuration-set-event-destination-options-builder>
  "The configuration-set-event-destination-options-builder> function updates a ConfigurationSetEventDestinationOptions$Builder instance using the provided configuration.
...
(defn configuration-set-event-destination-options-builder
  "Creates a  `ConfigurationSetEventDestinationOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[configuration-set-event-destination-options-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (configuration-set-event-destination-options-builder> (new ConfigurationSetEventDestinationOptions$Builder) id config))


(defn configuration-set-event-destination-props-builder>
  "The configuration-set-event-destination-props-builder> function updates a ConfigurationSetEventDestinationProps$Builder instance using the provided configuration.
...
(defn configuration-set-event-destination-props-builder
  "Creates a  `ConfigurationSetEventDestinationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[configuration-set-event-destination-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (configuration-set-event-destination-props-builder> (new ConfigurationSetEventDestinationProps$Builder) id config))


(defn configuration-set-props-builder>
  "The configuration-set-props-builder> function updates a ConfigurationSetProps$Builder instance using the provided configuration.
...
(defn configuration-set-props-builder
  "Creates a  `ConfigurationSetProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[configuration-set-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (configuration-set-props-builder> (new ConfigurationSetProps$Builder) id config))


(defn dedicated-ip-pool-builder>
  "The dedicated-ip-pool-builder> function updates a DedicatedIpPool$Builder instance using the provided configuration.
...
(defn dedicated-ip-pool-builder
  "Creates a  `DedicatedIpPool$Builder` instance using a scope and ID, applies the data configuration using the [[dedicated-ip-pool-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (dedicated-ip-pool-builder> (DedicatedIpPool$Builder/create scope (name id)) id config))


(defn dedicated-ip-pool-props-builder>
  "The dedicated-ip-pool-props-builder> function updates a DedicatedIpPoolProps$Builder instance using the provided configuration.
...
(defn dedicated-ip-pool-props-builder
  "Creates a  `DedicatedIpPoolProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[dedicated-ip-pool-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (dedicated-ip-pool-props-builder> (new DedicatedIpPoolProps$Builder) id config))


(defn dkim-identity-config-builder>
  "The dkim-identity-config-builder> function updates a DkimIdentityConfig$Builder instance using the provided configuration.
...
(defn dkim-identity-config-builder
  "Creates a  `DkimIdentityConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[dkim-identity-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (dkim-identity-config-builder> (new DkimIdentityConfig$Builder) id config))


(defn dkim-record-builder>
  "The dkim-record-builder> function updates a DkimRecord$Builder instance using the provided configuration.
...
(defn dkim-record-builder
  "Creates a  `DkimRecord$Builder` instance using a no-argument constructor, applies the data configuration using the [[dkim-record-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (dkim-record-builder> (new DkimRecord$Builder) id config))


(defn drop-spam-receipt-rule-builder>
  "The drop-spam-receipt-rule-builder> function updates a DropSpamReceiptRule$Builder instance using the provided configuration.
...
(defn drop-spam-receipt-rule-builder
  "Creates a  `DropSpamReceiptRule$Builder` instance using a scope and ID, applies the data configuration using the [[drop-spam-receipt-rule-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (drop-spam-receipt-rule-builder> (DropSpamReceiptRule$Builder/create scope (name id)) id config))


(defn drop-spam-receipt-rule-props-builder>
  "The drop-spam-receipt-rule-props-builder> function updates a DropSpamReceiptRuleProps$Builder instance using the provided configuration.
...
(defn drop-spam-receipt-rule-props-builder
  "Creates a  `DropSpamReceiptRuleProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[drop-spam-receipt-rule-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (drop-spam-receipt-rule-props-builder> (new DropSpamReceiptRuleProps$Builder) id config))


(defn email-identity-builder>
  "The email-identity-builder> function updates a EmailIdentity$Builder instance using the provided configuration.
...
(defn email-identity-builder
  "Creates a  `EmailIdentity$Builder` instance using a scope and ID, applies the data configuration using the [[email-identity-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (email-identity-builder> (EmailIdentity$Builder/create scope (name id)) id config))


(defn email-identity-props-builder>
  "The email-identity-props-builder> function updates a EmailIdentityProps$Builder instance using the provided configuration.
...
(defn email-identity-props-builder
  "Creates a  `EmailIdentityProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[email-identity-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (email-identity-props-builder> (new EmailIdentityProps$Builder) id config))


(defn lambda-action-config-builder>
  "The lambda-action-config-builder> function updates a LambdaActionConfig$Builder instance using the provided configuration.
...
(defn lambda-action-config-builder
  "Creates a  `LambdaActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[lambda-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (lambda-action-config-builder> (new LambdaActionConfig$Builder) id config))


(defn receipt-filter-builder>
  "The receipt-filter-builder> function updates a ReceiptFilter$Builder instance using the provided configuration.
...
(defn receipt-filter-builder
  "Creates a  `ReceiptFilter$Builder` instance using a scope and ID, applies the data configuration using the [[receipt-filter-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (receipt-filter-builder> (ReceiptFilter$Builder/create scope (name id)) id config))


(defn receipt-filter-props-builder>
  "The receipt-filter-props-builder> function updates a ReceiptFilterProps$Builder instance using the provided configuration.
...
(defn receipt-filter-props-builder
  "Creates a  `ReceiptFilterProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[receipt-filter-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (receipt-filter-props-builder> (new ReceiptFilterProps$Builder) id config))


(defn receipt-rule-action-config-builder>
  "The receipt-rule-action-config-builder> function updates a ReceiptRuleActionConfig$Builder instance using the provided configuration.
...
(defn receipt-rule-action-config-builder
  "Creates a  `ReceiptRuleActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[receipt-rule-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (receipt-rule-action-config-builder> (new ReceiptRuleActionConfig$Builder) id config))


(defn receipt-rule-builder>
  "The receipt-rule-builder> function updates a ReceiptRule$Builder instance using the provided configuration.
...
(defn receipt-rule-builder
  "Creates a  `ReceiptRule$Builder` instance using a scope and ID, applies the data configuration using the [[receipt-rule-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (receipt-rule-builder> (ReceiptRule$Builder/create scope (name id)) id config))


(defn receipt-rule-options-builder>
  "The receipt-rule-options-builder> function updates a ReceiptRuleOptions$Builder instance using the provided configuration.
...
(defn receipt-rule-options-builder
  "Creates a  `ReceiptRuleOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[receipt-rule-options-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (receipt-rule-options-builder> (new ReceiptRuleOptions$Builder) id config))


(defn receipt-rule-props-builder>
  "The receipt-rule-props-builder> function updates a ReceiptRuleProps$Builder instance using the provided configuration.
...
(defn receipt-rule-props-builder
  "Creates a  `ReceiptRuleProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[receipt-rule-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (receipt-rule-props-builder> (new ReceiptRuleProps$Builder) id config))


(defn receipt-rule-set-builder>
  "The receipt-rule-set-builder> function updates a ReceiptRuleSet$Builder instance using the provided configuration.
...
(defn receipt-rule-set-builder
  "Creates a  `ReceiptRuleSet$Builder` instance using a scope and ID, applies the data configuration using the [[receipt-rule-set-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (receipt-rule-set-builder> (ReceiptRuleSet$Builder/create scope (name id)) id config))


(defn receipt-rule-set-props-builder>
  "The receipt-rule-set-props-builder> function updates a ReceiptRuleSetProps$Builder instance using the provided configuration.
...
(defn receipt-rule-set-props-builder
  "Creates a  `ReceiptRuleSetProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[receipt-rule-set-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (receipt-rule-set-props-builder> (new ReceiptRuleSetProps$Builder) id config))


(defn s3-action-config-builder>
  "The s3-action-config-builder> function updates a S3ActionConfig$Builder instance using the provided configuration.
...
(defn s3-action-config-builder
  "Creates a  `S3ActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[s3-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (s3-action-config-builder> (new S3ActionConfig$Builder) id config))


(defn sns-action-config-builder>
  "The sns-action-config-builder> function updates a SNSActionConfig$Builder instance using the provided configuration.
...
(defn sns-action-config-builder
  "Creates a  `SNSActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[sns-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (sns-action-config-builder> (new SNSActionConfig$Builder) id config))


(defn stop-action-config-builder>
  "The stop-action-config-builder> function updates a StopActionConfig$Builder instance using the provided configuration.
...
(defn stop-action-config-builder
  "Creates a  `StopActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[stop-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (stop-action-config-builder> (new StopActionConfig$Builder) id config))


(defn vdm-attributes-builder>
  "The vdm-attributes-builder> function updates a VdmAttributes$Builder instance using the provided configuration.
...
(defn vdm-attributes-builder
  "Creates a  `VdmAttributes$Builder` instance using a scope and ID, applies the data configuration using the [[vdm-attributes-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
| `config` | map | Data configuration |"
  [^software.constructs.Construct scope id config]
  (vdm-attributes-builder> (VdmAttributes$Builder/create scope (name id)) id config))


(defn vdm-attributes-props-builder>
  "The vdm-attributes-props-builder> function updates a VdmAttributesProps$Builder instance using the provided configuration.
...
(defn vdm-attributes-props-builder
  "Creates a  `VdmAttributesProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[vdm-attributes-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (vdm-attributes-props-builder> (new VdmAttributesProps$Builder) id config))


(defn workmail-action-config-builder>
  "The workmail-action-config-builder> function updates a WorkmailActionConfig$Builder instance using the provided configuration.
...
(defn workmail-action-config-builder
  "Creates a  `WorkmailActionConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[workmail-action-config-builder>]] function, then builds it.  Takes the following arguments: 
...
| `config` | map | Data configuration |"
  [id config]
  (workmail-action-config-builder> (new WorkmailActionConfig$Builder) id config))