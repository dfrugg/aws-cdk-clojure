...
(defn cfn-capacity-reservation-builder
  "Creates a  `CfnCapacityReservation$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-capacity-reservation-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-capacity-reservation-capacity-assignment-configuration-property-builder
  "Creates a  `CfnCapacityReservation$CapacityAssignmentConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-capacity-reservation-capacity-assignment-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-capacity-reservation-capacity-assignment-property-builder
  "Creates a  `CfnCapacityReservation$CapacityAssignmentProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-capacity-reservation-capacity-assignment-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-capacity-reservation-props-builder
  "Creates a  `CfnCapacityReservationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-capacity-reservation-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-data-catalog-builder
  "Creates a  `CfnDataCatalog$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-data-catalog-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-data-catalog-props-builder
  "Creates a  `CfnDataCatalogProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-data-catalog-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-named-query-builder
  "Creates a  `CfnNamedQuery$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-named-query-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-named-query-props-builder
  "Creates a  `CfnNamedQueryProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-named-query-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-prepared-statement-builder
  "Creates a  `CfnPreparedStatement$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-prepared-statement-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-prepared-statement-props-builder
  "Creates a  `CfnPreparedStatementProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-prepared-statement-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-acl-configuration-property-builder
  "Creates a  `CfnWorkGroup$AclConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-acl-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-builder
  "Creates a  `CfnWorkGroup$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-work-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-work-group-customer-content-encryption-configuration-property-builder
  "Creates a  `CfnWorkGroup$CustomerContentEncryptionConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-customer-content-encryption-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-encryption-configuration-property-builder
  "Creates a  `CfnWorkGroup$EncryptionConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-encryption-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-engine-version-property-builder
  "Creates a  `CfnWorkGroup$EngineVersionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-engine-version-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-props-builder
  "Creates a  `CfnWorkGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-result-configuration-property-builder
  "Creates a  `CfnWorkGroup$ResultConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-result-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-result-configuration-updates-property-builder
  "Creates a  `CfnWorkGroup$ResultConfigurationUpdatesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-result-configuration-updates-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-work-group-configuration-property-builder
  "Creates a  `CfnWorkGroup$WorkGroupConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-work-group-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-work-group-work-group-configuration-updates-property-builder
  "Creates a  `CfnWorkGroup$WorkGroupConfigurationUpdatesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-work-group-work-group-configuration-updates-property-builder>]] function, then builds it.  Takes the following arguments: 
