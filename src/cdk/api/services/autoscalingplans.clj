...
(defn cfn-scaling-plan-application-source-property-builder
  "Creates a  `CfnScalingPlan$ApplicationSourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-application-source-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `applicationSource` | software.amazon.awscdk.services.autoscalingplans.CfnScalingPlan$ApplicationSourceProperty | [[cdk.support/lookup-entry]] | `:application-source` |
...
(defn cfn-scaling-plan-builder
  "Creates a  `CfnScalingPlan$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-scaling-plan-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
...
(defn cfn-scaling-plan-customized-load-metric-specification-property-builder
  "Creates a  `CfnScalingPlan$CustomizedLoadMetricSpecificationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-customized-load-metric-specification-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scaling-plan-customized-scaling-metric-specification-property-builder
  "Creates a  `CfnScalingPlan$CustomizedScalingMetricSpecificationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-customized-scaling-metric-specification-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scaling-plan-metric-dimension-property-builder
  "Creates a  `CfnScalingPlan$MetricDimensionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-metric-dimension-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scaling-plan-predefined-load-metric-specification-property-builder
  "Creates a  `CfnScalingPlan$PredefinedLoadMetricSpecificationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-predefined-load-metric-specification-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scaling-plan-predefined-scaling-metric-specification-property-builder
  "Creates a  `CfnScalingPlan$PredefinedScalingMetricSpecificationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-predefined-scaling-metric-specification-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scaling-plan-props-builder
  "Creates a  `CfnScalingPlanProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `customizedLoadMetricSpecification` | software.amazon.awscdk.services.autoscalingplans.CfnScalingPlan$CustomizedLoadMetricSpecificationProperty | [[cdk.support/lookup-entry]] | `:customized-load-metric-specification` |
| `disableDynamicScaling` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:disable-dynamic-scaling` |
...
| `targetTrackingConfigurations` | java.util.List | [[cdk.support/lookup-entry]] | `:target-tracking-configurations` |
"
...
(defn cfn-scaling-plan-scaling-instruction-property-builder
  "Creates a  `CfnScalingPlan$ScalingInstructionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-scaling-instruction-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scaling-plan-tag-filter-property-builder
  "Creates a  `CfnScalingPlan$TagFilterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-tag-filter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `customizedScalingMetricSpecification` | software.amazon.awscdk.services.autoscalingplans.CfnScalingPlan$CustomizedScalingMetricSpecificationProperty | [[cdk.support/lookup-entry]] | `:customized-scaling-metric-specification` |
...
(defn cfn-scaling-plan-target-tracking-configuration-property-builder
  "Creates a  `CfnScalingPlan$TargetTrackingConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scaling-plan-target-tracking-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
