...
(defn cfn-link-link-configuration-property-builder
  "Creates a  `CfnLink$LinkConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-link-link-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-link-link-filter-property-builder
  "Creates a  `CfnLink$LinkFilterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-link-link-filter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-sink-builder
  "Creates a  `CfnSink$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-sink-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-sink-props-builder
  "Creates a  `CfnSinkProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-sink-props-builder>]] function, then builds it.  Takes the following arguments: 
