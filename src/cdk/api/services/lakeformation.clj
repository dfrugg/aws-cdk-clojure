...
| `allowExternalDataFiltering` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:allow-external-data-filtering` |
...
| `tableResource` | software.amazon.awscdk.services.lakeformation.CfnPermissions$TableResourceProperty | [[cdk.support/lookup-entry]] | `:table-resource` |
...
| `dataLocation` | software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions$DataLocationResourceProperty | [[cdk.support/lookup-entry]] | `:data-location` |
...
| `lfTag` | software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions$LFTagKeyResourceProperty | [[cdk.support/lookup-entry]] | `:lf-tag` |
| `lfTagPolicy` | software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions$LFTagPolicyResourceProperty | [[cdk.support/lookup-entry]] | `:lf-tag-policy` |
...
| `catalogId` | java.lang.String | [[cdk.support/lookup-entry]] | `:catalog-id` |
| `columnNames` | java.util.List | [[cdk.support/lookup-entry]] | `:column-names` |
| `columnWildcard` | software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions$ColumnWildcardProperty | [[cdk.support/lookup-entry]] | `:column-wildcard` |
| `databaseName` | java.lang.String | [[cdk.support/lookup-entry]] | `:database-name` |
| `name` | java.lang.String | [[cdk.support/lookup-entry]] | `:name` |
"
...
| `useServiceLinkedRole` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:use-service-linked-role` |
