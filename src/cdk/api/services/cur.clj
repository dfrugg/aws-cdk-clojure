...
(defn cfn-report-definition-builder
  "Creates a  `CfnReportDefinition$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-report-definition-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-report-definition-props-builder
  "Creates a  `CfnReportDefinitionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-report-definition-props-builder>]] function, then builds it.  Takes the following arguments: 
