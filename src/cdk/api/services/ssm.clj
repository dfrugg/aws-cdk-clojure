...
|---|---|---|---|
| `applyOnlyAtCronInterval` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:apply-only-at-cron-interval` |
...
(defn cfn-association-builder
  "Creates a  `CfnAssociation$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-association-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `s3Location` | software.amazon.awscdk.services.ssm.CfnAssociation$S3OutputLocationProperty | [[cdk.support/lookup-entry]] | `:s3-location` |
"
...
(defn cfn-association-instance-association-output-location-property-builder
  "Creates a  `CfnAssociation$InstanceAssociationOutputLocationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-association-instance-association-output-location-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-association-props-builder
  "Creates a  `CfnAssociationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-association-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-association-s3-output-location-property-builder
  "Creates a  `CfnAssociation$S3OutputLocationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-association-s3-output-location-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-association-target-property-builder
  "Creates a  `CfnAssociation$TargetProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-association-target-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-document-attachments-source-property-builder
  "Creates a  `CfnDocument$AttachmentsSourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-document-attachments-source-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-document-builder
  "Creates a  `CfnDocument$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-document-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-document-document-requires-property-builder
  "Creates a  `CfnDocument$DocumentRequiresProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-document-document-requires-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-document-props-builder
  "Creates a  `CfnDocumentProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-document-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-builder
  "Creates a  `CfnMaintenanceWindow$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-maintenance-window-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-maintenance-window-props-builder
  "Creates a  `CfnMaintenanceWindowProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-target-builder
  "Creates a  `CfnMaintenanceWindowTarget$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-maintenance-window-target-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-maintenance-window-target-props-builder
  "Creates a  `CfnMaintenanceWindowTargetProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-target-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-target-targets-property-builder
  "Creates a  `CfnMaintenanceWindowTarget$TargetsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-target-targets-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `taskInvocationParameters` | software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask$TaskInvocationParametersProperty | [[cdk.support/lookup-entry]] | `:task-invocation-parameters` |
...
(defn cfn-maintenance-window-task-builder
  "Creates a  `CfnMaintenanceWindowTask$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-maintenance-window-task-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
| `cloudWatchOutputEnabled` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:cloud-watch-output-enabled` |
"
...
(defn cfn-maintenance-window-task-cloud-watch-output-config-property-builder
  "Creates a  `CfnMaintenanceWindowTask$CloudWatchOutputConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-cloud-watch-output-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-logging-info-property-builder
  "Creates a  `CfnMaintenanceWindowTask$LoggingInfoProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-logging-info-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-maintenance-window-automation-parameters-property-builder
  "Creates a  `CfnMaintenanceWindowTask$MaintenanceWindowAutomationParametersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-maintenance-window-automation-parameters-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-maintenance-window-lambda-parameters-property-builder
  "Creates a  `CfnMaintenanceWindowTask$MaintenanceWindowLambdaParametersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-maintenance-window-lambda-parameters-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `documentVersion` | java.lang.String | [[cdk.support/lookup-entry]] | `:document-version` |
| `notificationConfig` | software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask$NotificationConfigProperty | [[cdk.support/lookup-entry]] | `:notification-config` |
| `outputS3BucketName` | java.lang.String | [[cdk.support/lookup-entry]] | `:output-s3-bucket-name` |
| `outputS3KeyPrefix` | java.lang.String | [[cdk.support/lookup-entry]] | `:output-s3-key-prefix` |
| `parameters` | java.lang.Object | [[cdk.support/lookup-entry]] | `:parameters` |
| `serviceRoleArn` | java.lang.String | [[cdk.support/lookup-entry]] | `:service-role-arn` |
...
(defn cfn-maintenance-window-task-maintenance-window-run-command-parameters-property-builder
  "Creates a  `CfnMaintenanceWindowTask$MaintenanceWindowRunCommandParametersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-maintenance-window-run-command-parameters-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-maintenance-window-step-functions-parameters-property-builder
  "Creates a  `CfnMaintenanceWindowTask$MaintenanceWindowStepFunctionsParametersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-maintenance-window-step-functions-parameters-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-notification-config-property-builder
  "Creates a  `CfnMaintenanceWindowTask$NotificationConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-notification-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-props-builder
  "Creates a  `CfnMaintenanceWindowTaskProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-maintenance-window-task-target-property-builder
  "Creates a  `CfnMaintenanceWindowTask$TargetProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-target-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `maintenanceWindowLambdaParameters` | software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask$MaintenanceWindowLambdaParametersProperty | [[cdk.support/lookup-entry]] | `:maintenance-window-lambda-parameters` |
| `maintenanceWindowRunCommandParameters` | software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask$MaintenanceWindowRunCommandParametersProperty | [[cdk.support/lookup-entry]] | `:maintenance-window-run-command-parameters` |
| `maintenanceWindowStepFunctionsParameters` | software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask$MaintenanceWindowStepFunctionsParametersProperty | [[cdk.support/lookup-entry]] | `:maintenance-window-step-functions-parameters` |
"
...
(defn cfn-maintenance-window-task-task-invocation-parameters-property-builder
  "Creates a  `CfnMaintenanceWindowTask$TaskInvocationParametersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-maintenance-window-task-task-invocation-parameters-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `approvedPatchesEnableNonSecurity` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:approved-patches-enable-non-security` |
| `defaultBaseline` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:default-baseline` |
| `description` | java.lang.String | [[cdk.support/lookup-entry]] | `:description` |
...
(defn cfn-patch-baseline-builder
  "Creates a  `CfnPatchBaseline$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-patch-baseline-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `patchFilters` | java.util.List | [[cdk.support/lookup-entry]] | `:patch-filters` |
"
...
(defn cfn-patch-baseline-patch-filter-group-property-builder
  "Creates a  `CfnPatchBaseline$PatchFilterGroupProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-patch-baseline-patch-filter-group-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-patch-baseline-patch-filter-property-builder
  "Creates a  `CfnPatchBaseline$PatchFilterProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-patch-baseline-patch-filter-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-patch-baseline-patch-source-property-builder
  "Creates a  `CfnPatchBaseline$PatchSourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-patch-baseline-patch-source-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-patch-baseline-props-builder
  "Creates a  `CfnPatchBaselineProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-patch-baseline-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `patchRules` | java.util.List | [[cdk.support/lookup-entry]] | `:patch-rules` |
"
...
(defn cfn-patch-baseline-rule-group-property-builder
  "Creates a  `CfnPatchBaseline$RuleGroupProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-patch-baseline-rule-group-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-patch-baseline-rule-property-builder
  "Creates a  `CfnPatchBaseline$RuleProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-patch-baseline-rule-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-data-sync-aws-organizations-source-property-builder
  "Creates a  `CfnResourceDataSync$AwsOrganizationsSourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-data-sync-aws-organizations-source-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-data-sync-builder
  "Creates a  `CfnResourceDataSync$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-resource-data-sync-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-resource-data-sync-props-builder
  "Creates a  `CfnResourceDataSyncProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-data-sync-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-data-sync-s3-destination-property-builder
  "Creates a  `CfnResourceDataSync$S3DestinationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-data-sync-s3-destination-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-data-sync-sync-source-property-builder
  "Creates a  `CfnResourceDataSync$SyncSourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-data-sync-sync-source-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn common-string-parameter-attributes-builder
  "Creates a  `CommonStringParameterAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[common-string-parameter-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn list-parameter-attributes-builder
  "Creates a  `ListParameterAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[list-parameter-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn parameter-options-builder
  "Creates a  `ParameterOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[parameter-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn secure-string-parameter-attributes-builder
  "Creates a  `SecureStringParameterAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[secure-string-parameter-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn string-list-parameter-builder
  "Creates a  `StringListParameter$Builder` instance using a scope and ID, applies the data configuration using the [[string-list-parameter-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn string-list-parameter-props-builder
  "Creates a  `StringListParameterProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[string-list-parameter-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn string-parameter-attributes-builder
  "Creates a  `StringParameterAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[string-parameter-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn string-parameter-builder
  "Creates a  `StringParameter$Builder` instance using a scope and ID, applies the data configuration using the [[string-parameter-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn string-parameter-props-builder
  "Creates a  `StringParameterProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[string-parameter-props-builder>]] function, then builds it.  Takes the following arguments: 
