...
(defn cfn-account-audit-configuration-audit-check-configuration-property-builder
  "Creates a  `CfnAccountAuditConfiguration$AuditCheckConfigurationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-account-audit-configuration-audit-check-configuration-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `iotRoleAliasAllowsAccessToUnusedServicesCheck` | software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration$AuditCheckConfigurationProperty | [[cdk.support/lookup-entry]] | `:iot-role-alias-allows-access-to-unused-services-check` |
...
(defn cfn-account-audit-configuration-audit-check-configurations-property-builder
  "Creates a  `CfnAccountAuditConfiguration$AuditCheckConfigurationsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-account-audit-configuration-audit-check-configurations-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `sns` | software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration$AuditNotificationTargetProperty | [[cdk.support/lookup-entry]] | `:sns` |
"
...
(defn cfn-account-audit-configuration-audit-notification-target-configurations-property-builder
  "Creates a  `CfnAccountAuditConfiguration$AuditNotificationTargetConfigurationsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-account-audit-configuration-audit-notification-target-configurations-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-account-audit-configuration-audit-notification-target-property-builder
  "Creates a  `CfnAccountAuditConfiguration$AuditNotificationTargetProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-account-audit-configuration-audit-notification-target-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-account-audit-configuration-builder
  "Creates a  `CfnAccountAuditConfiguration$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-account-audit-configuration-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
...
(defn cfn-account-audit-configuration-props-builder
  "Creates a  `CfnAccountAuditConfigurationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-account-audit-configuration-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-billing-group-billing-group-properties-property-builder
  "Creates a  `CfnBillingGroup$BillingGroupPropertiesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-billing-group-billing-group-properties-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-billing-group-builder
  "Creates a  `CfnBillingGroup$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-billing-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-billing-group-props-builder
  "Creates a  `CfnBillingGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-billing-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-ca-certificate-builder
  "Creates a  `CfnCACertificate$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-ca-certificate-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-ca-certificate-props-builder
  "Creates a  `CfnCACertificateProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-ca-certificate-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-ca-certificate-registration-config-property-builder
  "Creates a  `CfnCACertificate$RegistrationConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-ca-certificate-registration-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-certificate-provider-builder
  "Creates a  `CfnCertificateProvider$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-certificate-provider-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-certificate-provider-props-builder
  "Creates a  `CfnCertificateProviderProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-certificate-provider-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-custom-metric-builder
  "Creates a  `CfnCustomMetric$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-custom-metric-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-custom-metric-props-builder
  "Creates a  `CfnCustomMetricProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-custom-metric-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-dimension-builder
  "Creates a  `CfnDimension$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-dimension-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-dimension-props-builder
  "Creates a  `CfnDimensionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-dimension-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-domain-configuration-authorizer-config-property-builder
  "Creates a  `CfnDomainConfiguration$AuthorizerConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-domain-configuration-authorizer-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-domain-configuration-builder
  "Creates a  `CfnDomainConfiguration$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-domain-configuration-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-domain-configuration-props-builder
  "Creates a  `CfnDomainConfigurationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-domain-configuration-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-domain-configuration-server-certificate-config-property-builder
  "Creates a  `CfnDomainConfiguration$ServerCertificateConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-domain-configuration-server-certificate-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-domain-configuration-server-certificate-summary-property-builder
  "Creates a  `CfnDomainConfiguration$ServerCertificateSummaryProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-domain-configuration-server-certificate-summary-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-domain-configuration-tls-config-property-builder
  "Creates a  `CfnDomainConfiguration$TlsConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-domain-configuration-tls-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-fleet-metric-aggregation-type-property-builder
  "Creates a  `CfnFleetMetric$AggregationTypeProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-fleet-metric-aggregation-type-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-fleet-metric-builder
  "Creates a  `CfnFleetMetric$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-fleet-metric-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-fleet-metric-props-builder
  "Creates a  `CfnFleetMetricProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-fleet-metric-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-abort-config-property-builder
  "Creates a  `CfnJobTemplate$AbortConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-abort-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-abort-criteria-property-builder
  "Creates a  `CfnJobTemplate$AbortCriteriaProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-abort-criteria-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-exponential-rollout-rate-property-builder
  "Creates a  `CfnJobTemplate$ExponentialRolloutRateProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-exponential-rollout-rate-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `retryCriteriaList` | java.util.List | [[cdk.support/lookup-entry]] | `:retry-criteria-list` |
"
...
(defn cfn-job-template-job-executions-retry-config-property-builder
  "Creates a  `CfnJobTemplate$JobExecutionsRetryConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-job-executions-retry-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-job-executions-rollout-config-property-builder
  "Creates a  `CfnJobTemplate$JobExecutionsRolloutConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-job-executions-rollout-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-maintenance-window-property-builder
  "Creates a  `CfnJobTemplate$MaintenanceWindowProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-maintenance-window-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-presigned-url-config-property-builder
  "Creates a  `CfnJobTemplate$PresignedUrlConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-presigned-url-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-rate-increase-criteria-property-builder
  "Creates a  `CfnJobTemplate$RateIncreaseCriteriaProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-rate-increase-criteria-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-retry-criteria-property-builder
  "Creates a  `CfnJobTemplate$RetryCriteriaProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-retry-criteria-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-job-template-timeout-config-property-builder
  "Creates a  `CfnJobTemplate$TimeoutConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-job-template-timeout-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-logging-builder
  "Creates a  `CfnLogging$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-logging-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-logging-props-builder
  "Creates a  `CfnLoggingProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-logging-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `addThingsToThingGroupParams` | software.amazon.awscdk.services.iot.CfnMitigationAction$AddThingsToThingGroupParamsProperty | [[cdk.support/lookup-entry]] | `:add-things-to-thing-group-params` |
| `enableIoTLoggingParams` | software.amazon.awscdk.services.iot.CfnMitigationAction$EnableIoTLoggingParamsProperty | [[cdk.support/lookup-entry]] | `:enable-io-t-logging-params` |
...
| `replaceDefaultPolicyVersionParams` | software.amazon.awscdk.services.iot.CfnMitigationAction$ReplaceDefaultPolicyVersionParamsProperty | [[cdk.support/lookup-entry]] | `:replace-default-policy-version-params` |
...
(defn cfn-mitigation-action-action-params-property-builder
  "Creates a  `CfnMitigationAction$ActionParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-action-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-add-things-to-thing-group-params-property-builder
  "Creates a  `CfnMitigationAction$AddThingsToThingGroupParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-add-things-to-thing-group-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-builder
  "Creates a  `CfnMitigationAction$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-mitigation-action-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-mitigation-action-enable-io-t-logging-params-property-builder
  "Creates a  `CfnMitigationAction$EnableIoTLoggingParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-enable-io-t-logging-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-props-builder
  "Creates a  `CfnMitigationActionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-publish-finding-to-sns-params-property-builder
  "Creates a  `CfnMitigationAction$PublishFindingToSnsParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-publish-finding-to-sns-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-replace-default-policy-version-params-property-builder
  "Creates a  `CfnMitigationAction$ReplaceDefaultPolicyVersionParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-replace-default-policy-version-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-update-ca-certificate-params-property-builder
  "Creates a  `CfnMitigationAction$UpdateCACertificateParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-update-ca-certificate-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-mitigation-action-update-device-certificate-params-property-builder
  "Creates a  `CfnMitigationAction$UpdateDeviceCertificateParamsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-mitigation-action-update-device-certificate-params-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-policy-principal-attachment-builder
  "Creates a  `CfnPolicyPrincipalAttachment$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-policy-principal-attachment-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-policy-principal-attachment-props-builder
  "Creates a  `CfnPolicyPrincipalAttachmentProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-policy-principal-attachment-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `description` | java.lang.String | [[cdk.support/lookup-entry]] | `:description` |
| `enabled` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:enabled` |
| `preProvisioningHook` | software.amazon.awscdk.services.iot.CfnProvisioningTemplate$ProvisioningHookProperty | [[cdk.support/lookup-entry]] | `:pre-provisioning-hook` |
...
(defn cfn-provisioning-template-builder
  "Creates a  `CfnProvisioningTemplate$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-provisioning-template-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-provisioning-template-props-builder
  "Creates a  `CfnProvisioningTemplateProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-provisioning-template-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-provisioning-template-provisioning-hook-property-builder
  "Creates a  `CfnProvisioningTemplate$ProvisioningHookProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-provisioning-template-provisioning-hook-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-resource-specific-logging-builder
  "Creates a  `CfnResourceSpecificLogging$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-resource-specific-logging-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-resource-specific-logging-props-builder
  "Creates a  `CfnResourceSpecificLoggingProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-resource-specific-logging-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-role-alias-builder
  "Creates a  `CfnRoleAlias$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-role-alias-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-role-alias-props-builder
  "Creates a  `CfnRoleAliasProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-role-alias-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-scheduled-audit-builder
  "Creates a  `CfnScheduledAudit$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-scheduled-audit-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-scheduled-audit-props-builder
  "Creates a  `CfnScheduledAuditProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-scheduled-audit-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-alert-target-property-builder
  "Creates a  `CfnSecurityProfile$AlertTargetProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-alert-target-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `statisticalThreshold` | software.amazon.awscdk.services.iot.CfnSecurityProfile$StatisticalThresholdProperty | [[cdk.support/lookup-entry]] | `:statistical-threshold` |
...
(defn cfn-security-profile-behavior-criteria-property-builder
  "Creates a  `CfnSecurityProfile$BehaviorCriteriaProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-behavior-criteria-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `criteria` | software.amazon.awscdk.services.iot.CfnSecurityProfile$BehaviorCriteriaProperty | [[cdk.support/lookup-entry]] | `:criteria` |
...
(defn cfn-security-profile-behavior-property-builder
  "Creates a  `CfnSecurityProfile$BehaviorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-behavior-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-machine-learning-detection-config-property-builder
  "Creates a  `CfnSecurityProfile$MachineLearningDetectionConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-machine-learning-detection-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-metric-dimension-property-builder
  "Creates a  `CfnSecurityProfile$MetricDimensionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-metric-dimension-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-metric-to-retain-property-builder
  "Creates a  `CfnSecurityProfile$MetricToRetainProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-metric-to-retain-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-metric-value-property-builder
  "Creates a  `CfnSecurityProfile$MetricValueProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-metric-value-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-metrics-export-config-property-builder
  "Creates a  `CfnSecurityProfile$MetricsExportConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-metrics-export-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-security-profile-statistical-threshold-property-builder
  "Creates a  `CfnSecurityProfile$StatisticalThresholdProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-security-profile-statistical-threshold-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-software-package-builder
  "Creates a  `CfnSoftwarePackage$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-software-package-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-software-package-props-builder
  "Creates a  `CfnSoftwarePackageProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-software-package-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-software-package-version-builder
  "Creates a  `CfnSoftwarePackageVersion$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-software-package-version-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-software-package-version-props-builder
  "Creates a  `CfnSoftwarePackageVersionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-software-package-version-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-attribute-payload-property-builder
  "Creates a  `CfnThing$AttributePayloadProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-attribute-payload-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-builder
  "Creates a  `CfnThing$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-thing-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-thing-group-attribute-payload-property-builder
  "Creates a  `CfnThingGroup$AttributePayloadProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-group-attribute-payload-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-group-builder
  "Creates a  `CfnThingGroup$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-thing-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-thing-group-props-builder
  "Creates a  `CfnThingGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-group-thing-group-properties-property-builder
  "Creates a  `CfnThingGroup$ThingGroupPropertiesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-group-thing-group-properties-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-principal-attachment-builder
  "Creates a  `CfnThingPrincipalAttachment$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-thing-principal-attachment-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-thing-principal-attachment-props-builder
  "Creates a  `CfnThingPrincipalAttachmentProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-principal-attachment-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-props-builder
  "Creates a  `CfnThingProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-type-builder
  "Creates a  `CfnThingType$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-thing-type-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-thing-type-props-builder
  "Creates a  `CfnThingTypeProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-type-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-thing-type-thing-type-properties-property-builder
  "Creates a  `CfnThingType$ThingTypePropertiesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-thing-type-thing-type-properties-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `cloudwatchMetric` | software.amazon.awscdk.services.iot.CfnTopicRule$CloudwatchMetricActionProperty | [[cdk.support/lookup-entry]] | `:cloudwatch-metric` |
...
| `firehose` | software.amazon.awscdk.services.iot.CfnTopicRule$FirehoseActionProperty | [[cdk.support/lookup-entry]] | `:firehose` |
| `http` | software.amazon.awscdk.services.iot.CfnTopicRule$HttpActionProperty | [[cdk.support/lookup-entry]] | `:http` |
...
| `kinesis` | software.amazon.awscdk.services.iot.CfnTopicRule$KinesisActionProperty | [[cdk.support/lookup-entry]] | `:kinesis` |
...
| `openSearch` | software.amazon.awscdk.services.iot.CfnTopicRule$OpenSearchActionProperty | [[cdk.support/lookup-entry]] | `:open-search` |
| `republish` | software.amazon.awscdk.services.iot.CfnTopicRule$RepublishActionProperty | [[cdk.support/lookup-entry]] | `:republish` |
| `s3` | software.amazon.awscdk.services.iot.CfnTopicRule$S3ActionProperty | [[cdk.support/lookup-entry]] | `:s3` |
| `sns` | software.amazon.awscdk.services.iot.CfnTopicRule$SnsActionProperty | [[cdk.support/lookup-entry]] | `:sns` |
...
(defn cfn-topic-rule-action-property-builder
  "Creates a  `CfnTopicRule$ActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-asset-property-timestamp-property-builder
  "Creates a  `CfnTopicRule$AssetPropertyTimestampProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-asset-property-timestamp-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-asset-property-value-property-builder
  "Creates a  `CfnTopicRule$AssetPropertyValueProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-asset-property-value-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-asset-property-variant-property-builder
  "Creates a  `CfnTopicRule$AssetPropertyVariantProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-asset-property-variant-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-builder
  "Creates a  `CfnTopicRule$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-topic-rule-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-topic-rule-cloudwatch-alarm-action-property-builder
  "Creates a  `CfnTopicRule$CloudwatchAlarmActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-cloudwatch-alarm-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-cloudwatch-logs-action-property-builder
  "Creates a  `CfnTopicRule$CloudwatchLogsActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-cloudwatch-logs-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-cloudwatch-metric-action-property-builder
  "Creates a  `CfnTopicRule$CloudwatchMetricActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-cloudwatch-metric-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-destination-builder
  "Creates a  `CfnTopicRuleDestination$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-topic-rule-destination-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-topic-rule-destination-http-url-destination-summary-property-builder
  "Creates a  `CfnTopicRuleDestination$HttpUrlDestinationSummaryProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-destination-http-url-destination-summary-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-destination-props-builder
  "Creates a  `CfnTopicRuleDestinationProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-destination-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-destination-vpc-destination-properties-property-builder
  "Creates a  `CfnTopicRuleDestination$VpcDestinationPropertiesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-destination-vpc-destination-properties-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-dynamo-d-bv2-action-property-builder
  "Creates a  `CfnTopicRule$DynamoDBv2ActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-dynamo-d-bv2-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-dynamo-db-action-property-builder
  "Creates a  `CfnTopicRule$DynamoDBActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-dynamo-db-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-elasticsearch-action-property-builder
  "Creates a  `CfnTopicRule$ElasticsearchActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-elasticsearch-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-firehose-action-property-builder
  "Creates a  `CfnTopicRule$FirehoseActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-firehose-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-http-action-header-property-builder
  "Creates a  `CfnTopicRule$HttpActionHeaderProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-http-action-header-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-http-action-property-builder
  "Creates a  `CfnTopicRule$HttpActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-http-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `sigv4` | software.amazon.awscdk.services.iot.CfnTopicRule$SigV4AuthorizationProperty | [[cdk.support/lookup-entry]] | `:sigv4` |
"
...
(defn cfn-topic-rule-http-authorization-property-builder
  "Creates a  `CfnTopicRule$HttpAuthorizationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-http-authorization-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-iot-analytics-action-property-builder
  "Creates a  `CfnTopicRule$IotAnalyticsActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-iot-analytics-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-iot-events-action-property-builder
  "Creates a  `CfnTopicRule$IotEventsActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-iot-events-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-iot-site-wise-action-property-builder
  "Creates a  `CfnTopicRule$IotSiteWiseActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-iot-site-wise-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-kafka-action-header-property-builder
  "Creates a  `CfnTopicRule$KafkaActionHeaderProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-kafka-action-header-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `clientProperties` | java.util.Map | [[cdk.support/lookup-entry]] | `:client-properties` |
...
(defn cfn-topic-rule-kafka-action-property-builder
  "Creates a  `CfnTopicRule$KafkaActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-kafka-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-kinesis-action-property-builder
  "Creates a  `CfnTopicRule$KinesisActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-kinesis-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-lambda-action-property-builder
  "Creates a  `CfnTopicRule$LambdaActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-lambda-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-location-action-property-builder
  "Creates a  `CfnTopicRule$LocationActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-location-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-open-search-action-property-builder
  "Creates a  `CfnTopicRule$OpenSearchActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-open-search-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-props-builder
  "Creates a  `CfnTopicRuleProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| `propertyValues` | java.util.List | [[cdk.support/lookup-entry]] | `:property-values` |
"
...
(defn cfn-topic-rule-put-asset-property-value-entry-property-builder
  "Creates a  `CfnTopicRule$PutAssetPropertyValueEntryProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-put-asset-property-value-entry-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-put-item-input-property-builder
  "Creates a  `CfnTopicRule$PutItemInputProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-put-item-input-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-republish-action-headers-property-builder
  "Creates a  `CfnTopicRule$RepublishActionHeadersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-republish-action-headers-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-republish-action-property-builder
  "Creates a  `CfnTopicRule$RepublishActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-republish-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-s3-action-property-builder
  "Creates a  `CfnTopicRule$S3ActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-s3-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-sig-v4-authorization-property-builder
  "Creates a  `CfnTopicRule$SigV4AuthorizationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-sig-v4-authorization-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-sns-action-property-builder
  "Creates a  `CfnTopicRule$SnsActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-sns-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-sqs-action-property-builder
  "Creates a  `CfnTopicRule$SqsActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-sqs-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-step-functions-action-property-builder
  "Creates a  `CfnTopicRule$StepFunctionsActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-step-functions-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-timestamp-property-builder
  "Creates a  `CfnTopicRule$TimestampProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-timestamp-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-timestream-action-property-builder
  "Creates a  `CfnTopicRule$TimestreamActionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-timestream-action-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-timestream-dimension-property-builder
  "Creates a  `CfnTopicRule$TimestreamDimensionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-timestream-dimension-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-timestream-timestamp-property-builder
  "Creates a  `CfnTopicRule$TimestreamTimestampProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-timestream-timestamp-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `description` | java.lang.String | [[cdk.support/lookup-entry]] | `:description` |
| `errorAction` | software.amazon.awscdk.services.iot.CfnTopicRule$ActionProperty | [[cdk.support/lookup-entry]] | `:error-action` |
...
(defn cfn-topic-rule-topic-rule-payload-property-builder
  "Creates a  `CfnTopicRule$TopicRulePayloadProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-topic-rule-payload-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-topic-rule-user-property-property-builder
  "Creates a  `CfnTopicRule$UserPropertyProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-topic-rule-user-property-property-builder>]] function, then builds it.  Takes the following arguments: 
