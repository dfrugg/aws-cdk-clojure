...
(defn add-behavior-options-builder
  "Creates a  `AddBehaviorOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[add-behavior-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn behavior-builder
  "Creates a  `Behavior$Builder` instance using a no-argument constructor, applies the data configuration using the [[behavior-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn behavior-options-builder
  "Creates a  `BehaviorOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[behavior-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cache-policy-builder
  "Creates a  `CachePolicy$Builder` instance using a scope and ID, applies the data configuration using the [[cache-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
...
(defn cache-policy-props-builder
  "Creates a  `CachePolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cache-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cache-policy-builder
  "Creates a  `CfnCachePolicy$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-cache-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-cache-policy-cache-policy-config-property-builder
  "Creates a  `CfnCachePolicy$CachePolicyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cache-policy-cache-policy-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cache-policy-cookies-config-property-builder
  "Creates a  `CfnCachePolicy$CookiesConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cache-policy-cookies-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cache-policy-headers-config-property-builder
  "Creates a  `CfnCachePolicy$HeadersConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cache-policy-headers-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cache-policy-parameters-in-cache-key-and-forwarded-to-origin-property-builder
  "Creates a  `CfnCachePolicy$ParametersInCacheKeyAndForwardedToOriginProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cache-policy-parameters-in-cache-key-and-forwarded-to-origin-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cache-policy-props-builder
  "Creates a  `CfnCachePolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cache-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cache-policy-query-strings-config-property-builder
  "Creates a  `CfnCachePolicy$QueryStringsConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cache-policy-query-strings-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `cloudFrontOriginAccessIdentityConfig` | software.amazon.awscdk.services.cloudfront.CfnCloudFrontOriginAccessIdentity$CloudFrontOriginAccessIdentityConfigProperty | [[cdk.support/lookup-entry]] | `:cloud-front-origin-access-identity-config` |
"
...
(defn cfn-cloud-front-origin-access-identity-builder
  "Creates a  `CfnCloudFrontOriginAccessIdentity$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-cloud-front-origin-access-identity-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-cloud-front-origin-access-identity-cloud-front-origin-access-identity-config-property-builder
  "Creates a  `CfnCloudFrontOriginAccessIdentity$CloudFrontOriginAccessIdentityConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cloud-front-origin-access-identity-cloud-front-origin-access-identity-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-cloud-front-origin-access-identity-props-builder
  "Creates a  `CfnCloudFrontOriginAccessIdentityProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-cloud-front-origin-access-identity-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `continuousDeploymentPolicyConfig` | software.amazon.awscdk.services.cloudfront.CfnContinuousDeploymentPolicy$ContinuousDeploymentPolicyConfigProperty | [[cdk.support/lookup-entry]] | `:continuous-deployment-policy-config` |
"
...
(defn cfn-continuous-deployment-policy-builder
  "Creates a  `CfnContinuousDeploymentPolicy$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-continuous-deployment-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-continuous-deployment-policy-continuous-deployment-policy-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$ContinuousDeploymentPolicyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-continuous-deployment-policy-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-props-builder
  "Creates a  `CfnContinuousDeploymentPolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-session-stickiness-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$SessionStickinessConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-session-stickiness-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-single-header-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$SingleHeaderConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-single-header-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-single-header-policy-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$SingleHeaderPolicyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-single-header-policy-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-single-weight-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$SingleWeightConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-single-weight-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-single-weight-policy-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$SingleWeightPolicyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-single-weight-policy-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-continuous-deployment-policy-traffic-config-property-builder
  "Creates a  `CfnContinuousDeploymentPolicy$TrafficConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-continuous-deployment-policy-traffic-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-builder
  "Creates a  `CfnDistribution$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-distribution-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-distribution-cache-behavior-property-builder
  "Creates a  `CfnDistribution$CacheBehaviorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-cache-behavior-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-cookies-property-builder
  "Creates a  `CfnDistribution$CookiesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-cookies-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-custom-error-response-property-builder
  "Creates a  `CfnDistribution$CustomErrorResponseProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-custom-error-response-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-custom-origin-config-property-builder
  "Creates a  `CfnDistribution$CustomOriginConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-custom-origin-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-default-cache-behavior-property-builder
  "Creates a  `CfnDistribution$DefaultCacheBehaviorProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-default-cache-behavior-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `defaultCacheBehavior` | software.amazon.awscdk.services.cloudfront.CfnDistribution$DefaultCacheBehaviorProperty | [[cdk.support/lookup-entry]] | `:default-cache-behavior` |
...
| `ipv6Enabled` | java.lang.Boolean | [[cdk.support/lookup-entry]] | `:ipv6-enabled` |
...
| `origins` | java.util.List | [[cdk.support/lookup-entry]] | `:origins` |
...
(defn cfn-distribution-distribution-config-property-builder
  "Creates a  `CfnDistribution$DistributionConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-distribution-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-forwarded-values-property-builder
  "Creates a  `CfnDistribution$ForwardedValuesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-forwarded-values-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-function-association-property-builder
  "Creates a  `CfnDistribution$FunctionAssociationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-function-association-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-geo-restriction-property-builder
  "Creates a  `CfnDistribution$GeoRestrictionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-geo-restriction-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-lambda-function-association-property-builder
  "Creates a  `CfnDistribution$LambdaFunctionAssociationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-lambda-function-association-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-legacy-custom-origin-property-builder
  "Creates a  `CfnDistribution$LegacyCustomOriginProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-legacy-custom-origin-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-legacy-s3-origin-property-builder
  "Creates a  `CfnDistribution$LegacyS3OriginProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-legacy-s3-origin-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-logging-property-builder
  "Creates a  `CfnDistribution$LoggingProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-logging-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-custom-header-property-builder
  "Creates a  `CfnDistribution$OriginCustomHeaderProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-custom-header-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `statusCodes` | software.amazon.awscdk.services.cloudfront.CfnDistribution$StatusCodesProperty | [[cdk.support/lookup-entry]] | `:status-codes` |
"
...
(defn cfn-distribution-origin-group-failover-criteria-property-builder
  "Creates a  `CfnDistribution$OriginGroupFailoverCriteriaProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-group-failover-criteria-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-group-member-property-builder
  "Creates a  `CfnDistribution$OriginGroupMemberProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-group-member-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-group-members-property-builder
  "Creates a  `CfnDistribution$OriginGroupMembersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-group-members-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-group-property-builder
  "Creates a  `CfnDistribution$OriginGroupProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-group-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-groups-property-builder
  "Creates a  `CfnDistribution$OriginGroupsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-groups-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-property-builder
  "Creates a  `CfnDistribution$OriginProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-origin-shield-property-builder
  "Creates a  `CfnDistribution$OriginShieldProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-origin-shield-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-props-builder
  "Creates a  `CfnDistributionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-props-builder>]] function, then builds it.  Takes the following arguments: 
...
| Field | DataType | Lookup Function | Data Key |
|---|---|---|---|
| `geoRestriction` | software.amazon.awscdk.services.cloudfront.CfnDistribution$GeoRestrictionProperty | [[cdk.support/lookup-entry]] | `:geo-restriction` |
"
...
(defn cfn-distribution-restrictions-property-builder
  "Creates a  `CfnDistribution$RestrictionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-restrictions-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-s3-origin-config-property-builder
  "Creates a  `CfnDistribution$S3OriginConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-s3-origin-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-status-codes-property-builder
  "Creates a  `CfnDistribution$StatusCodesProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-status-codes-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-distribution-viewer-certificate-property-builder
  "Creates a  `CfnDistribution$ViewerCertificateProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-distribution-viewer-certificate-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-function-function-config-property-builder
  "Creates a  `CfnFunction$FunctionConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-function-function-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-function-function-metadata-property-builder
  "Creates a  `CfnFunction$FunctionMetadataProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-function-function-metadata-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-function-key-value-store-association-property-builder
  "Creates a  `CfnFunction$KeyValueStoreAssociationProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-function-key-value-store-association-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-key-group-builder
  "Creates a  `CfnKeyGroup$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-key-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-key-group-key-group-config-property-builder
  "Creates a  `CfnKeyGroup$KeyGroupConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-key-group-key-group-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-key-group-props-builder
  "Creates a  `CfnKeyGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-key-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-key-value-store-builder
  "Creates a  `CfnKeyValueStore$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-key-value-store-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-key-value-store-import-source-property-builder
  "Creates a  `CfnKeyValueStore$ImportSourceProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-key-value-store-import-source-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-key-value-store-props-builder
  "Creates a  `CfnKeyValueStoreProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-key-value-store-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-monitoring-subscription-builder
  "Creates a  `CfnMonitoringSubscription$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-monitoring-subscription-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-monitoring-subscription-monitoring-subscription-property-builder
  "Creates a  `CfnMonitoringSubscription$MonitoringSubscriptionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-monitoring-subscription-monitoring-subscription-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-monitoring-subscription-props-builder
  "Creates a  `CfnMonitoringSubscriptionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-monitoring-subscription-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-monitoring-subscription-realtime-metrics-subscription-config-property-builder
  "Creates a  `CfnMonitoringSubscription$RealtimeMetricsSubscriptionConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-monitoring-subscription-realtime-metrics-subscription-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-origin-access-control-builder
  "Creates a  `CfnOriginAccessControl$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-origin-access-control-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-origin-access-control-origin-access-control-config-property-builder
  "Creates a  `CfnOriginAccessControl$OriginAccessControlConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-access-control-origin-access-control-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-origin-access-control-props-builder
  "Creates a  `CfnOriginAccessControlProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-access-control-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-origin-request-policy-builder
  "Creates a  `CfnOriginRequestPolicy$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-origin-request-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-origin-request-policy-cookies-config-property-builder
  "Creates a  `CfnOriginRequestPolicy$CookiesConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-request-policy-cookies-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-origin-request-policy-headers-config-property-builder
  "Creates a  `CfnOriginRequestPolicy$HeadersConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-request-policy-headers-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `headersConfig` | software.amazon.awscdk.services.cloudfront.CfnOriginRequestPolicy$HeadersConfigProperty | [[cdk.support/lookup-entry]] | `:headers-config` |
| `name` | java.lang.String | [[cdk.support/lookup-entry]] | `:name` |
...
(defn cfn-origin-request-policy-origin-request-policy-config-property-builder
  "Creates a  `CfnOriginRequestPolicy$OriginRequestPolicyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-request-policy-origin-request-policy-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-origin-request-policy-props-builder
  "Creates a  `CfnOriginRequestPolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-request-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-origin-request-policy-query-strings-config-property-builder
  "Creates a  `CfnOriginRequestPolicy$QueryStringsConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-origin-request-policy-query-strings-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-public-key-builder
  "Creates a  `CfnPublicKey$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-public-key-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-public-key-props-builder
  "Creates a  `CfnPublicKeyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-public-key-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-public-key-public-key-config-property-builder
  "Creates a  `CfnPublicKey$PublicKeyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-public-key-public-key-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-realtime-log-config-builder
  "Creates a  `CfnRealtimeLogConfig$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-realtime-log-config-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-realtime-log-config-end-point-property-builder
  "Creates a  `CfnRealtimeLogConfig$EndPointProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-realtime-log-config-end-point-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-realtime-log-config-kinesis-stream-config-property-builder
  "Creates a  `CfnRealtimeLogConfig$KinesisStreamConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-realtime-log-config-kinesis-stream-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-realtime-log-config-props-builder
  "Creates a  `CfnRealtimeLogConfigProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-realtime-log-config-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-access-control-allow-headers-property-builder
  "Creates a  `CfnResponseHeadersPolicy$AccessControlAllowHeadersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-access-control-allow-headers-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-access-control-allow-methods-property-builder
  "Creates a  `CfnResponseHeadersPolicy$AccessControlAllowMethodsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-access-control-allow-methods-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-access-control-allow-origins-property-builder
  "Creates a  `CfnResponseHeadersPolicy$AccessControlAllowOriginsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-access-control-allow-origins-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-access-control-expose-headers-property-builder
  "Creates a  `CfnResponseHeadersPolicy$AccessControlExposeHeadersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-access-control-expose-headers-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-builder
  "Creates a  `CfnResponseHeadersPolicy$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-response-headers-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-response-headers-policy-content-security-policy-property-builder
  "Creates a  `CfnResponseHeadersPolicy$ContentSecurityPolicyProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-content-security-policy-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-content-type-options-property-builder
  "Creates a  `CfnResponseHeadersPolicy$ContentTypeOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-content-type-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-cors-config-property-builder
  "Creates a  `CfnResponseHeadersPolicy$CorsConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-cors-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-custom-header-property-builder
  "Creates a  `CfnResponseHeadersPolicy$CustomHeaderProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-custom-header-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-custom-headers-config-property-builder
  "Creates a  `CfnResponseHeadersPolicy$CustomHeadersConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-custom-headers-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-frame-options-property-builder
  "Creates a  `CfnResponseHeadersPolicy$FrameOptionsProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-frame-options-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-props-builder
  "Creates a  `CfnResponseHeadersPolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-referrer-policy-property-builder
  "Creates a  `CfnResponseHeadersPolicy$ReferrerPolicyProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-referrer-policy-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-remove-header-property-builder
  "Creates a  `CfnResponseHeadersPolicy$RemoveHeaderProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-remove-header-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-remove-headers-config-property-builder
  "Creates a  `CfnResponseHeadersPolicy$RemoveHeadersConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-remove-headers-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-response-headers-policy-config-property-builder
  "Creates a  `CfnResponseHeadersPolicy$ResponseHeadersPolicyConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-response-headers-policy-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
| `referrerPolicy` | software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy$ReferrerPolicyProperty | [[cdk.support/lookup-entry]] | `:referrer-policy` |
...
(defn cfn-response-headers-policy-security-headers-config-property-builder
  "Creates a  `CfnResponseHeadersPolicy$SecurityHeadersConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-security-headers-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-server-timing-headers-config-property-builder
  "Creates a  `CfnResponseHeadersPolicy$ServerTimingHeadersConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-server-timing-headers-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-strict-transport-security-property-builder
  "Creates a  `CfnResponseHeadersPolicy$StrictTransportSecurityProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-strict-transport-security-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-response-headers-policy-xss-protection-property-builder
  "Creates a  `CfnResponseHeadersPolicy$XSSProtectionProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-response-headers-policy-xss-protection-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-streaming-distribution-builder
  "Creates a  `CfnStreamingDistribution$Builder` instance using a scope and ID, applies the data configuration using the [[cfn-streaming-distribution-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cfn-streaming-distribution-logging-property-builder
  "Creates a  `CfnStreamingDistribution$LoggingProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-streaming-distribution-logging-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-streaming-distribution-props-builder
  "Creates a  `CfnStreamingDistributionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-streaming-distribution-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-streaming-distribution-s3-origin-property-builder
  "Creates a  `CfnStreamingDistribution$S3OriginProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-streaming-distribution-s3-origin-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-streaming-distribution-streaming-distribution-config-property-builder
  "Creates a  `CfnStreamingDistribution$StreamingDistributionConfigProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-streaming-distribution-streaming-distribution-config-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cfn-streaming-distribution-trusted-signers-property-builder
  "Creates a  `CfnStreamingDistribution$TrustedSignersProperty$Builder` instance using a no-argument constructor, applies the data configuration using the [[cfn-streaming-distribution-trusted-signers-property-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cloud-front-web-distribution-attributes-builder
  "Creates a  `CloudFrontWebDistributionAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[cloud-front-web-distribution-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn cloud-front-web-distribution-builder
  "Creates a  `CloudFrontWebDistribution$Builder` instance using a scope and ID, applies the data configuration using the [[cloud-front-web-distribution-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn cloud-front-web-distribution-props-builder
  "Creates a  `CloudFrontWebDistributionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[cloud-front-web-distribution-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn custom-origin-config-builder
  "Creates a  `CustomOriginConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[custom-origin-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn distribution-attributes-builder
  "Creates a  `DistributionAttributes$Builder` instance using a no-argument constructor, applies the data configuration using the [[distribution-attributes-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn distribution-builder
  "Creates a  `Distribution$Builder` instance using a scope and ID, applies the data configuration using the [[distribution-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn distribution-props-builder
  "Creates a  `DistributionProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[distribution-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn edge-lambda-builder
  "Creates a  `EdgeLambda$Builder` instance using a no-argument constructor, applies the data configuration using the [[edge-lambda-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn error-response-builder
  "Creates a  `ErrorResponse$Builder` instance using a no-argument constructor, applies the data configuration using the [[error-response-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn file-code-options-builder
  "Creates a  `FileCodeOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[file-code-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn function-association-builder
  "Creates a  `FunctionAssociation$Builder` instance using a no-argument constructor, applies the data configuration using the [[function-association-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn key-group-builder
  "Creates a  `KeyGroup$Builder` instance using a scope and ID, applies the data configuration using the [[key-group-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn key-group-props-builder
  "Creates a  `KeyGroupProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[key-group-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn key-value-store-builder
  "Creates a  `KeyValueStore$Builder` instance using a scope and ID, applies the data configuration using the [[key-value-store-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn key-value-store-props-builder
  "Creates a  `KeyValueStoreProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[key-value-store-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn lambda-function-association-builder
  "Creates a  `LambdaFunctionAssociation$Builder` instance using a no-argument constructor, applies the data configuration using the [[lambda-function-association-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn logging-configuration-builder
  "Creates a  `LoggingConfiguration$Builder` instance using a no-argument constructor, applies the data configuration using the [[logging-configuration-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-access-identity-builder
  "Creates a  `OriginAccessIdentity$Builder` instance using a scope and ID, applies the data configuration using the [[origin-access-identity-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn origin-access-identity-props-builder
  "Creates a  `OriginAccessIdentityProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-access-identity-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-bind-config-builder
  "Creates a  `OriginBindConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-bind-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-bind-options-builder
  "Creates a  `OriginBindOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-bind-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-failover-config-builder
  "Creates a  `OriginFailoverConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-failover-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-options-builder
  "Creates a  `OriginOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-props-builder
  "Creates a  `OriginProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn origin-request-policy-builder
  "Creates a  `OriginRequestPolicy$Builder` instance using a scope and ID, applies the data configuration using the [[origin-request-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn origin-request-policy-props-builder
  "Creates a  `OriginRequestPolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[origin-request-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn public-key-builder
  "Creates a  `PublicKey$Builder` instance using a scope and ID, applies the data configuration using the [[public-key-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn public-key-props-builder
  "Creates a  `PublicKeyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[public-key-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn realtime-log-config-builder
  "Creates a  `RealtimeLogConfig$Builder` instance using a scope and ID, applies the data configuration using the [[realtime-log-config-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn realtime-log-config-props-builder
  "Creates a  `RealtimeLogConfigProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[realtime-log-config-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-custom-header-builder
  "Creates a  `ResponseCustomHeader$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-custom-header-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-custom-headers-behavior-builder
  "Creates a  `ResponseCustomHeadersBehavior$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-custom-headers-behavior-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-content-security-policy-builder
  "Creates a  `ResponseHeadersContentSecurityPolicy$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-content-security-policy-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-content-type-options-builder
  "Creates a  `ResponseHeadersContentTypeOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-content-type-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-cors-behavior-builder
  "Creates a  `ResponseHeadersCorsBehavior$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-cors-behavior-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-frame-options-builder
  "Creates a  `ResponseHeadersFrameOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-frame-options-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-policy-builder
  "Creates a  `ResponseHeadersPolicy$Builder` instance using a scope and ID, applies the data configuration using the [[response-headers-policy-builder>]] function, then builds it.  Takes the following arguments: 
| Argument | DataType | Description |
|---|---|---|
| `scope` | software.constructs.Construct | The parent scope construct of the object being built. |
| `id` | String or Keyword or Symbol | Value to use as both the ID of the object being build and the namespace when looking up configuration values. |
...
(defn response-headers-policy-props-builder
  "Creates a  `ResponseHeadersPolicyProps$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-policy-props-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-referrer-policy-builder
  "Creates a  `ResponseHeadersReferrerPolicy$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-referrer-policy-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-strict-transport-security-builder
  "Creates a  `ResponseHeadersStrictTransportSecurity$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-strict-transport-security-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-headers-xss-protection-builder
  "Creates a  `ResponseHeadersXSSProtection$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-headers-xss-protection-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn response-security-headers-behavior-builder
  "Creates a  `ResponseSecurityHeadersBehavior$Builder` instance using a no-argument constructor, applies the data configuration using the [[response-security-headers-behavior-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn s3-origin-config-builder
  "Creates a  `S3OriginConfig$Builder` instance using a no-argument constructor, applies the data configuration using the [[s3-origin-config-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn source-configuration-builder
  "Creates a  `SourceConfiguration$Builder` instance using a no-argument constructor, applies the data configuration using the [[source-configuration-builder>]] function, then builds it.  Takes the following arguments: 
...
(defn viewer-certificate-options-builder
  "Creates a  `ViewerCertificateOptions$Builder` instance using a no-argument constructor, applies the data configuration using the [[viewer-certificate-options-builder>]] function, then builds it.  Takes the following arguments: 
